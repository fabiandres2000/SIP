  ...
  methods: {
    ...
    agregar: function agregar() {
      ...
      this.datos.push((_this$datos$push = {
        ...
        muniTexto: this.showText(this.corregimientosData.muni, this.muni_options[this.veredasData.dpto])
      }, _defineProperty(_this$datos$push, "muniTexto", this.corregimientosData.muni.texto), _defineProperty(_this$datos$push, "corregimiento", this.corregimientosData.corregimiento), _this$datos$push));
      this.corregimientosData.corregimiento = "";
    },
