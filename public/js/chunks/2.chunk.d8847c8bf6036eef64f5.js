...
var isPhoneNumber = vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_7__["helpers"].regex("numeric", /^3[0-9]{9}$/);
var alpha = vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_7__["helpers"].regex("alpha", /^[a-zA-Z]*$/);
var alphaNumAndDotValidator = vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_7__["helpers"].regex("alphaNumAndDot", /^[a-z\d.]*$/i);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      mOCOL2: false,
      format: "yyyy-MM-dd",
      lenguaje: vuejs_datepicker_dist_locale__WEBPACK_IMPORTED_MODULE_6__["es"],
  ...
  methods: {
    ...
    cambiarTab1: function cambiarTab1(opcion, actual) {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3() {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 51:
                _this3.vectorAyuda = [];
                _context3.next = 54;
                return _this3.valJef2();

              case 54:
                if (_this3.vectorAyuda.length > 0) {
                  for (i = 0; i < _this3.vectorAyuda.length; i++) {
                    if (_this3.vectorAyuda[i].error === "ERROR1") {
                      val = (_this3.vectorAyuda[i].identificacion / 1).toFixed(0).replace(".", ",");
                      iden = val.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".");

                      _this3.$swal("Validar...!", "El Documento <b>" + iden + "</b> De La Fila <b>" + (i + 1) + "</b> Se Encuentra Registrado", "warning");
              ...
              case 62:
                _this3.vectorAyuda = [];
                _context3.next = 65;
                return _this3.valInt2();

              case 65:
                if (_this3.vectorAyuda.length > 0) {
                  for (_i = 0; _i < _this3.vectorAyuda.length; _i++) {
                    if (_this3.vectorAyuda[_i].error === "ERROR1") {
                      val1 = (_this3.vectorAyuda[_i].identificacion / 1).toFixed(0).replace(".", ",");
                      iden1 = val1.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".");

                      _this3.$swal("Validar...!", "El Documento <b>" + iden1 + "</b> De La Fila <b>" + (_i + 1) + "</b> Se Encuentra Registrado En Los Integrantes", "warning");
              ...
              case 73:
                ...
                return _Servicios_caracterizacion_servicios__WEBPACK_IMPORTED_MODULE_1__["guardar"](parametros).then(function (respuesta) {
                  ...
                  _this3.$swal("Error...!", "No se pudo guardar los datos de la pestaña investigación", "error");
              ...
              case 115:
                _context3.prev = 115;
                _context3.t2 = _context3["catch"](110);
                _context3.t3 = _context3.t2.response.status;
                _context3.next = _context3.t3 === 419 ? 120 : _context3.t3 === 422 ? 122 : 124;
                break;
              ...
              case 186:
                _context3.prev = 186;
                _context3.t4 = _context3["catch"](181);
                _context3.t5 = _context3.t4.response.status;
                _context3.next = _context3.t5 === 419 ? 191 : _context3.t5 === 422 ? 193 : 195;
                break;

              case 191:
                _this3.$swal("Error...!", "Ocurrio un error!", "error");

                return _context3.abrupt("break", 197);
              ...
              case 248:
                _context3.prev = 248;
                _context3.t6 = _context3["catch"](243);
                _context3.t7 = _context3.t6.response.status;
                _context3.next = _context3.t7 === 419 ? 253 : _context3.t7 === 422 ? 255 : 257;
                break;
              ...
              case 313:
                _context3.prev = 313;
                _context3.t8 = _context3["catch"](308);
                _context3.t9 = _context3.t8.response.status;
                _context3.next = _context3.t9 === 419 ? 318 : _context3.t9 === 422 ? 320 : 322;
                break;

              case 318:
                _this3.$swal("Error...!", "Ocurrio un error!", "error");

                return _context3.abrupt("break", 324);
              ...
              case 366:
                _context3.prev = 366;
                _context3.t10 = _context3["catch"](361);
                _context3.t11 = _context3.t10.response.status;
                _context3.next = _context3.t11 === 419 ? 371 : _context3.t11 === 422 ? 373 : 375;
                break;
        ...
        }, _callee3, null, [[74, 79], [110, 115], [181, 186], [243, 248], [308, 313], [361, 366]]);
      }))();
    },
    //VALIDACIONES
                    ...
                    while (1) {
                      switch (_context4.prev = _context4.next) {
                        case 0:
                          parametros = {
                            _token: _this4.csrf,
                            identificacion: _this4.datosJefe[i].identificacion
                          };
                          _context4.prev = 1;
                          _context4.next = 4;
            ...
            switch (_context7.prev = _context7.next) {
              case 0:
                ...
                _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _loop2(i) {
                  var parametros;
                  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _loop2$(_context6) {
                    while (1) {
                      switch (_context6.prev = _context6.next) {
                        case 0:
                          parametros = {
                            _token: _this5.csrf,
                            identificacion: _this5.datos[i].identificacion
                          };
                          _context6.prev = 1;
                          _context6.next = 4;
            ...
            switch (_context8.prev = _context8.next) {
              case 0:
                ...
                return _Servicios_caracterizacion_servicios__WEBPACK_IMPORTED_MODULE_1__["nuevaCaracterizacion"](parametros).then(function (respuesta) {
                  _this6.dpto_options = respuesta.data.arrayDpto;
                  _this6.muni_options = respuesta.data.arrayMuni;
                  _this6.corregi_options = respuesta.data.arrayCorregi;
                  _this6.vereda_options = respuesta.data.arrayVeredas; // this.barrio_options = respuesta.data.arrayBarrios;

                  _this6.parentesco_options = respuesta.data.arrayParentesco;
                  _this6.estado_options = respuesta.data.arrayEstado;
                  _this6.escolaridad_options = respuesta.data.arrayEscolaridad;
                  _this6.ocupacion_options = respuesta.data.arrayOcupacion;
                  _this6.etnia_options = respuesta.data.arrayEtnia;
                  _this6.admini_options = respuesta.data.arrayAdmini;
                  _this6.clasifi_options = respuesta.data.arrayCLasifi;
                  _this6.grados_option = respuesta.data.arrayGrados;
                  _this6.morbilidadNacer_options = respuesta.data.arrayMorbilidadNacer;
                  _this6.morbilidad_options = respuesta.data.arrayMorbilidad;
                  _this6.metodos_options = respuesta.data.arrayMetodos;
                  _this6.motivos_options = respuesta.data.arrayMotivos;
                  _this6.grupos_options = respuesta.data.arrayGrupos;
                  _this6.enfcro_options = respuesta.data.arrayEnfCro;
                  _this6.enfinf_options = respuesta.data.arrayEnfInf;
                  _this6.religion_options = respuesta.data.arrayReligion;
                });
              ...
              case 6:
                ...
                _context8.next = _context8.t1 === 422 ? 11 : 13;
                break;
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 48:
                ...
                return _Servicios_caracterizacion_servicios__WEBPACK_IMPORTED_MODULE_1__["validar"](parametros).then(function (respuesta) {
                  if (respuesta.data.OPC == "EXISTE") {
                    ...
                    // VERIFICAR SI ESTA EN LA TABLA
                    var resultado = _this7.datos.filter(function (identi) {
                      return identi.identificacion.includes(_this7.CA1.identificacion);
                    }); // VERIFICAR SI ESTA EN LA TABLA


                    if (resultado.length > 0) {
                      _this7.$swal("Validar...!", "El Documento <b>" + _this7.CA1.identificacion + "</b> Se Encuentra Agregado", "warning");

                      return false;
                    } else {
                      var nacimiento = moment(_this7.CA1.fecha_nac);
                      var hoy = moment();
                      var edad = 0;
                      ...
                      _this7.datos.push({
                        id: 0,
                        tipo_id: _this7.CA1.tipo_id,
                        identificacion: _this7.CA1.identificacion,
                        sexo: _this7.CA1.sexo,
                        parentesco: _this7.CA1.parentesco,
                        textoParentesco: _this7.showText(_this7.CA1.parentesco, _this7.parentesco_options),
                        pnom: _this7.CA1.pnom,
                        snom: _this7.CA1.snom,
                        pape: _this7.CA1.pape,
                        sape: _this7.CA1.sape,
                        estado_civil: _this7.CA1.estado_civil,
                        textoEstado: _this7.showText(_this7.CA1.estado_civil, _this7.estado_options),
                        fecha_nac: _this7.CA1.fecha_nac,
                        edad: edad,
                        afi_entidad: _this7.CA1.afi_entidad,
                        otra_eps: _this7.CA1.otra_eps,
                        tipo_afiliacion: _this7.CA1.tipo_afiliacion,
                        embarazo: _this7.CA1.embarazo,
                        embarazo_multiple: _this7.CA1.embarazo_multiple,
                        discapacidad: _this7.CA1.discapacidad,
                        escolaridad: _this7.CA1.escolaridad,
                        textoEscolaridad: _this7.showText(_this7.CA1.escolaridad, _this7.escolaridad_options),
                        ocupacion: _this7.CA1.ocupacion,
                        textoOcupacion: _this7.showText(_this7.CA1.ocupacion, _this7.ocupacion_options),
                        colegio: _this7.CA1.colegio,
                        grado: _this7.CA1.grado,
                        entiende: _this7.CA1.entiende,
                        migrante: _this7.CA1.migrante,
                        pyp: _this7.CA1.pyp,
                        etnia: _this7.CA1.etnia,
                        textoEtnia: _this7.showText(_this7.CA1.etnia, _this7.etnia_options),
                        clasificacion: _this7.CA1.clasificacion,
                        puntaje_sisben: _this7.CA1.puntaje_sisben,
                        jefe: _this7.CA1.jefe
                      });

                      var indice = _this7.datos.findIndex(function (identi) {
                        return identi.identificacion === _this7.CA1.identificacion;
                      });

                      _this7.vectorIntegrante.push({
                        index: indice,
                        identificacion: _this7.CA1.identificacion
                      });

                      _this7.CA1.id = "INTE"; // AGREGAR NIÑOS MENORES DE 1 AÑO

                      if (edad <= 0) {
                        _this7.Amenores1Anio(_this7.CA1);
                      } // AGREGAR NIÑOS MENORES DE 1 AÑO
                      // AGREGAR DE 1 A 5 AÑOS


                      if (edad >= 1 && edad <= 5) {
                        _this7.Ade1a5Anio(_this7.CA1, edad);
                      } // AGREGAR DE 1 A 5 AÑOS
                      // AGREGAR DE 6 A 11 AÑOS


                      if (edad >= 6 && edad <= 11) {
                        _this7.Ade6a11Anio(_this7.CA1, edad);
                      } // AGREGAR DE 6 A 11 AÑOS
                      // AGREGAR DE 10 A 59 AÑOS


                      if (edad >= 10 && edad <= 59) {
                        _this7.Ade10a59Anio(_this7.CA1, edad);
                      } // AGREGAR DE 10 A 59 AÑOS
                      // AGREGAR PARTO POSTPARTO
                      // alert(this.CA1.embarazo_multiple);


                      if (_this7.CA1.embarazo === "SI") {
                        _this7.AParPost(_this7.CA1, edad);
                      } // AGREGAR PARTO POSTPARTO
                      // AGREGAR DE 12 A 17 AÑOS


                      if (edad >= 12 && edad <= 17) {
                        _this7.Ade12a17Anio(_this7.CA1, edad);
                      } // AGREGAR DE 12 A 17 AÑOS
                      // AGREGAR DE 18 A 28 AÑOS


                      if (edad >= 18 && edad <= 28) {
                        _this7.Ade18a28Anio(_this7.CA1, edad);
                      } // AGREGAR DE 18 A 28 AÑOS
                      // AGREGAR DE 29 A 59 AÑOS


                      if (edad >= 29 && edad <= 59) {
                        _this7.Ade29a59Anio(_this7.CA1, edad);
                      } // AGREGAR DE 29 A 59 AÑOS
                      // AGREGAR DE 60 ó MAS AÑOS


                      if (edad >= 60) {
                        _this7.Ade60Anio(_this7.CA1, edad);
                      } // AGREGAR DE 60 ó MAS AÑOS
                      // AGREGAR MIGRANTES


                      if (_this7.CA1.migrante === "SI") {
                        _this7.AMigra(_this7.CA1, edad);
                      } // AGREGAR MIGRANTES
              ...
              case 55:
                ...
                _context9.next = _context9.t1 === 419 ? 60 : _context9.t1 === 422 ? 62 : 64;
                break;
          ...
          while (1) {
            switch (_context10.prev = _context10.next) {
                ...
                return _Servicios_caracterizacion_servicios__WEBPACK_IMPORTED_MODULE_1__["validarJefe"](parametros).then(function (respuesta) {
                  if (respuesta.data.OPC == "EXISTE") {
                    ...
                    var resultado = _this8.datosJefe.filter(function (identi) {
                      return identi.identificacion.includes(_this8.caracData.identificacion);
                    }); // VERIFICAR SI ESTA EN LA TABLA
                    ...
                    if (resultado.length) {
                      ...
                      var nacimiento = moment(_this8.caracData.fecha_nacimiento);
                      var hoy = moment();
                      var edad = 0;
                      ...
                      if (edad < 14) {
                        _this8.$swal("Validar...!", "El Valor de la edad introducido no es aceptable, debe ser mayor ó igual a 14 años", "warning");

                        return false;
                      }

                      _this8.datosJefe.push({
                        id: 0,
                        id_hogar: 0,
                        telefono: _this8.caracData.telefono,
                        puntaje_sisben: _this8.caracData.puntaje_sisben,
                        afiliacion_entidad: _this8.caracData.afiliacion_entidad,
                        otra_eps: _this8.caracData.otra_eps,
                        tipo_id: _this8.caracData.tipo_id,
                        identificacion: _this8.caracData.identificacion,
                        sexo: _this8.caracData.sexo,
                        parentesco: _this8.caracData.parentesco,
                        textoParentesco: _this8.showText(_this8.caracData.parentesco, _this8.parentesco_options),
                        pnom: _this8.caracData.pnom,
                        snom: _this8.caracData.snom,
                        pape: _this8.caracData.pape,
                        sape: _this8.caracData.sape,
                        salario: _this8.caracData.salario,
                        estado_civil: _this8.caracData.estado_civil,
                        textoEstado: _this8.showText(_this8.caracData.estado_civil, _this8.estado_options),
                        fecha_nacimiento: _this8.caracData.fecha_nacimiento,
                        tipo_afiliacion: _this8.caracData.tipo_afiliacion,
                        embarazo: _this8.caracData.embarazo,
                        embarazo_multiple: _this8.caracData.embarazo_multiple,
                        discapacidad: _this8.caracData.discapacidad,
                        nivel_escolaridad: _this8.caracData.nivel_escolaridad,
                        ocupacion: _this8.caracData.ocupacion,
                        textoOcupacion: _this8.showText(_this8.caracData.ocupacion, _this8.ocupacion_options),
                        colegio: _this8.caracData.colegio,
                        grado: _this8.caracData.grado,
                        entiende: _this8.caracData.entiende,
                        migrante: _this8.caracData.migrante,
                        pyp: _this8.caracData.pyp,
                        etnia: _this8.caracData.etnia,
                        textoEtnia: _this8.showText(_this8.caracData.etnia, _this8.etnia_options),
                        clasificacion: _this8.caracData.clasificacion,
                        edad: _this8.caracData.edad
                      });

                      var indice = _this8.datosJefe.findIndex(function (identi) {
                        return identi.identificacion === _this8.caracData.identificacion;
                      });

                      _this8.vectorJefes.push({
                        index: indice,
                        identificacion: _this8.caracData.identificacion
                      }); // AGREGAR FACTORES


                      _this8.AFactores(_this8.caracData, edad); // AGREGAR FACTORES


                      _this8.caracData.id = "JEFE"; // AGREGAR DE 10 A 59 AÑOS

                      if (edad >= 10 && edad <= 59) {
                        _this8.Ade10a59Anio(_this8.caracData, edad);
                      } // AGREGAR DE 10 A 59 AÑOS
                      // AGREGAR PARTO POSTPARTO
                      // alert(this.CA1.embarazo_multiple);


                      if (_this8.caracData.embarazo === "SI") {
                        _this8.AParPost(_this8.caracData, edad);
                      } // AGREGAR PARTO POSTPARTO
                      // AGREGAR DE 12 A 17 AÑOS


                      if (edad >= 12 && edad <= 17) {
                        _this8.Ade12a17Anio(_this8.caracData, edad);
                      } // AGREGAR DE 12 A 17 AÑOS
                      // AGREGAR DE 18 A 28 AÑOS


                      if (edad >= 18 && edad <= 28) {
                        _this8.Ade18a28Anio(_this8.caracData, edad);
                      } // AGREGAR DE 18 A 28 AÑOS
                      // AGREGAR DE 29 A 59 AÑOS


                      if (edad >= 29 && edad <= 59) {
                        _this8.Ade29a59Anio(_this8.caracData, edad);
                      } // AGREGAR DE 29 A 59 AÑOS
                      // AGREGAR DE 60 ó MAS AÑOS


                      if (edad >= 60) {
                        _this8.Ade60Anio(_this8.caracData, edad);
                      } // AGREGAR DE 60 ó MAS AÑOS
                      // AGREGAR MIGRANTES


                      if (_this8.caracData.migrante === "SI") {
                        _this8.AMigra(_this8.caracData, edad);
                      } // AGREGAR MIGRANTES
              ...
              case 8:
                ...
                this.errorDevuelto = _context10.t0.response.data.errors;
    ...
    validarTablaIntegrantes: function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee9() {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee9$(_context12) {
          while (1) {
            switch (_context12.prev = _context12.next) {
              case 0:
                ...
                _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _loop3(i) {
                  var parametros;
                  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _loop3$(_context11) {
                    while (1) {
                      switch (_context11.prev = _context11.next) {
                        case 0:
                          parametros = {
                            _token: _this9.csrf,
                            identificacion: _this9.datos[i].identificacion
                          };
                          _context11.prev = 1;
                          _context11.next = 4;
                          return _Servicios_caracterizacion_servicios__WEBPACK_IMPORTED_MODULE_1__["validarJefe"](parametros).then(function (respuesta) {
                            if (respuesta.data.OPC == "EXISTE") {
                              ...
                              var resultado = _this9.datos.filter(function (identi) {
                                return identi.identificacion.includes(_this9.datos[i].identificacion);
                              }); // VERIFICAR SI ESTA EN LA TABLA


                              if (resultado.length > 1) {
                                _this9.$swal("Validar...!", "El Documento <b>" + _this9.datos[i].identificacion + "</b> De La Fila <b>" + (i + 1) + "</b>  Se Encuentra Agregado En La Tabla de Integrantes", "warning"); // item.identificacion="";


                                return false;
                              } else {
                                if (_this9.datos[i].tipo_id === "0") {
                                  _this9.$swal("Error...!", "Por favor seleccione un <b>tipo de identificación</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this9.datos[i].identificacion === "") {
                                  _this9.$swal("Error...!", "Por favor digite una <b>identificación</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this9.datos[i].pnom === "") {
                                  _this9.$swal("Error...!", "Por favor digite el <b>primer nombre</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this9.datos[i].pape === "") {
                                  _this9.$swal("Error...!", "Por favor digite el <b>primer apellido</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this9.datos[i].sexo === "0") {
                                  _this9.$swal("Error...!", "Por favor seleccione el <b>sexo</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this9.datos[i].parentesco === "0") {
                                  _this9.$swal("Error...!", "Por favor seleccione el <b>parentesco</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this9.datos[i].estado_civil === "0") {
                                  _this9.$swal("Error...!", "Por favor seleccione el <b>estado civil</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this9.datos[i].fecha_nac === "") {
                                  _this9.$swal("Error...!", "Por favor seleccione la <b>fecha de nacimiento</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this9.datos[i].afi_entidad === "0") {
                                  _this9.$swal("Error...!", "Por favor seleccione la <b>eps</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this9.datos[i].tipo_afiliacion === "0") {
                                  _this9.$swal("Error...!", "Por favor seleccione el <b>tipo de afiliación</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this9.datos[i].escolaridad === "0") {
                                  _this9.$swal("Error...!", "Por favor seleccione el <b>nivel de escolaridad</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this9.datos[i].ocupacion === "0") {
                                  _this9.$swal("Error...!", "Por favor seleccione la <b>ocupación</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this9.datos[i].etnia === "0") {
                                  _this9.$swal("Error...!", "Por favor seleccione la <b>etnia</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this9.datos[i].clasificacion === "0") {
                                  _this9.$swal("Error...!", "Por favor seleccione la <b>clasificacion de la etnia</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this9.datos[i].jefe === "0") {
                                  _this9.$swal("Error...!", "Por favor seleccione el <b>jefe de hogar</b> en la fila " + (i + 1) + " de los integrantes", "error");
              ...
              case 2:
                ...
                return _context12.delegateYield(_loop3(i), "t0", 4);
            ...
            switch (_context14.prev = _context14.next) {
              case 0:
                ...
                _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _loop4(i) {
                  var parametros;
                  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _loop4$(_context13) {
                    while (1) {
                      switch (_context13.prev = _context13.next) {
                        case 0:
                          parametros = {
                            _token: _this10.csrf,
                            identificacion: _this10.datosJefe[i].identificacion
                          };
                          _context13.prev = 1;
                          _context13.next = 4;
                          return _Servicios_caracterizacion_servicios__WEBPACK_IMPORTED_MODULE_1__["validarJefe"](parametros).then(function (respuesta) {
                            if (respuesta.data.OPC == "EXISTE") {
                              ...
                              var resultado = _this10.datosJefe.filter(function (identi) {
                                return identi.identificacion.includes(_this10.datosJefe[i].identificacion);
                              }); // VERIFICAR SI ESTA EN LA TABLA


                              if (resultado.length > 1) {
                                _this10.$swal("Validar...!", "El Documento <b>" + _this10.datosJefe[i].identificacion + "</b> De La Fila <b>" + (i + 1) + "</b>  Se Encuentra Agregado En La Tabla de Jefes de Hogar", "warning"); // item.identificacion="";


                                return false;
                              } else {
                                if (_this10.datosJefe[i].tipo_id === "") {
                                  _this10.$swal("Error...!", "Por favor seleccione un <b>tipo de identificación</b> en la fila " + (i + 1) + " de los jefes de hogar", "error");

                                  return false;
                                }

                                if (_this10.datosJefe[i].identificacion === "") {
                                  _this10.$swal("Error...!", "Por favor digite una <b>identificación</b> en la fila " + (i + 1) + " de los jefes de hogar", "error");

                                  return false;
                                }

                                if (_this10.datosJefe[i].pnom === "") {
                                  _this10.$swal("Error...!", "Por favor digite el <b>primer nombre</b> en la fila " + (i + 1) + " de los jefes de hogar", "error");

                                  return false;
                                }

                                if (_this10.datosJefe[i].pape === "") {
                                  _this10.$swal("Error...!", "Por favor digite el <b>primer apellido</b> en la fila " + (i + 1) + " de los jefes de hogar", "error");

                                  return false;
                                }

                                if (_this10.datosJefe[i].sexo === "") {
                                  _this10.$swal("Error...!", "Por favor seleccione el <b>sexo</b> en la fila " + (i + 1) + " de los jefes de hogar", "error");

                                  return false;
                                }

                                if (_this10.datosJefe[i].parentesco === "") {
                                  _this10.$swal("Error...!", "Por favor seleccione el <b>parentesco</b> en la fila " + (i + 1) + " de los jefes de hogar", "error");

                                  return false;
                                }

                                if (_this10.datosJefe[i].estado_civil === "") {
                                  _this10.$swal("Error...!", "Por favor seleccione el <b>estado civil</b> en la fila " + (i + 1) + " de los jefes de hogar", "error");

                                  return false;
                                }

                                if (_this10.datosJefe[i].fecha_nacimiento === "") {
                                  _this10.$swal("Error...!", "Por favor seleccione la <b>fecha de nacimiento</b> en la fila " + (i + 1) + " de los jefes de hogar", "error");

                                  return false;
                                }

                                if (_this10.datosJefe[i].afiliacion_entidad === "") {
                                  _this10.$swal("Error...!", "Por favor seleccione la <b>eps</b> en la fila " + (i + 1) + " de los jefes de hogar", "error");

                                  return false;
                                }

                                if (_this10.datosJefe[i].tipo_afiliacion === "") {
                                  _this10.$swal("Error...!", "Por favor seleccione el <b>tipo de afiliación</b> en la fila " + (i + 1) + " de los jefes de hogar", "error");

                                  return false;
                                }

                                if (_this10.datosJefe[i].nivel_escolaridad === "") {
                                  _this10.$swal("Error...!", "Por favor seleccione el <b>nivel de escolaridad</b> en la fila " + (i + 1) + " de los jefes de hogar", "error");

                                  return false;
                                }

                                if (_this10.datosJefe[i].ocupacion === "") {
                                  _this10.$swal("Error...!", "Por favor seleccione la <b>ocupación</b> en la fila " + (i + 1) + " de los jefes de hogar", "error");

                                  return false;
                                }

                                if (_this10.datosJefe[i].etnia === "") {
                                  _this10.$swal("Error...!", "Por favor seleccione la <b>etnia</b> en la fila " + (i + 1) + " de los jefes de hogar", "error");

                                  return false;
                                }

                                if (_this10.datosJefe[i].clasificacion === "") {
                                  _this10.$swal("Error...!", "Por favor seleccione la <b>clasificacion de la etnia</b> en la fila " + (i + 1) + " de los jefes de hogar", "error");

                                  return false;
                                }

                                if (_this10.datosJefe[i].salario === "") {
                                  _this10.$swal("Error...!", "Por favor digite el <b>salario</b> en la fila " + (i + 1) + " de los jefes de hogar", "error");
              ...
              case 2:
                ...
                return _context14.delegateYield(_loop4(i), "t0", 4);
          ...
          while (1) {
            switch (_context15.prev = _context15.next) {
              ...
              case 14:
                ...
                return _Servicios_caracterizacion_servicios__WEBPACK_IMPORTED_MODULE_1__["guardar"](parametros).then(function (respuesta) {
                  ...
                  if (respuesta.data.OPC == "SI") {
                    ...
                    _this11.$swal("Guardar...!", "Datos Guardados Exitosamente!", "success");

                    _this11.$router.push("/gestion");
                  }
                  ...
                  if (respuesta.data.OPC == "VALIDAR") {
                    ...
                    _this11.$swal("Validar...!", "El Documento <b>" + iden + "</b> Se Encuentra Registrado", "success");
                  }
                })["catch"](function (error) {
                  _this11.errorDevuelto = error.response.data.errors;
                  _this11.entrarPorError = true;
                });
              ...
              case 22:
                ...
                _context15.next = _context15.t1 === 419 ? 27 : _context15.t1 === 422 ? 29 : 31;
                break;
    ...
    cambiarCombo: function () {
      ...
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee12(caja) {
        var _this12 = this;

        var parametros, _parametros6;

        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee12$(_context16) {
          while (1) {
            switch (_context16.prev = _context16.next) {
              case 0:
                if (caja === "dpto") {
                  ...
                  console.log("LLEGUE");
                  $('.selectBus').select2().trigger('change');
                }
                ...
                return _Servicios_barrios_servicios__WEBPACK_IMPORTED_MODULE_2__["comboBarrios"](parametros).then(function (respuesta) {
                  _this12.barrio_options = respuesta.data.arrayBarrios;
                });
              ...
              case 20:
                ...
                return _Servicios_colegios_servicios__WEBPACK_IMPORTED_MODULE_3__["combo"](parametros).then(function (respuesta) {
                  _this12.colegio_options = respuesta.data.arrayColegios;
                });
              ...
              case 25:
                _context16.prev = 25;
                _context16.t2 = _context16["catch"](20);
                _context16.t3 = _context16.t2.response.status;
                _context16.next = _context16.t3 === 422 ? 30 : 32;
                break;
              ...
              case 44:
                _context16.prev = 44;
                _context16.t4 = _context16["catch"](39);
                _context16.t5 = _context16.t4.response.status;
                _context16.next = _context16.t5 === 422 ? 49 : 51;
                break;

              case 49:
                this.$swal("Error...!", "Ocurrio un error!", "error");
                return _context16.abrupt("break", 53);
              ...
              case 58:
                _context16.prev = 58;
                _context16.t6 = _context16["catch"](53);
                _context16.t7 = _context16.t6.response.status;
                _context16.next = _context16.t7 === 422 ? 63 : 65;
                break;
        ...
        }, _callee12, this, [[6, 11], [20, 25], [39, 44], [53, 58]]);
      }));
