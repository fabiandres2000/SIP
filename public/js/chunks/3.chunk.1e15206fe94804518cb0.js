...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
                ...
                return _Servicios_caracterizacion_servicios__WEBPACK_IMPORTED_MODULE_1__["validar"](parametros).then(function (respuesta) {
                  if (respuesta.data.OPC == "EXISTE") {
                    ...
                    if (resultado.length > 0) {
                      ...
                      var indice = _this2.datos.findIndex(function (identi) {
                        return identi.identificacion === _this2.CA1.identificacion;
                      });

                      _this2.vectorIntegrante.push({
                        index: indice,
                        identificacion: _this2.CA1.identificacion
                      });

                      _this2.CA1.id = "INTE"; // AGREGAR NIÑOS MENORES DE 1 AÑO
                ...
                return _Servicios_caracterizacion_servicios__WEBPACK_IMPORTED_MODULE_1__["validarJefe"](parametros).then(function (respuesta) {
                  if (respuesta.data.OPC == "EXISTE") {
                    ...
                    if (resultado.length) {
                      ...
                      if (edad < 14) {
                        _this3.$swal("Validar...!", "El Valor de la edad introducido no es aceptable, debe ser mayor ó igual a 14 años", "warning");
                      ...
                      var indice = _this3.datosJefe.findIndex(function (identi) {
                        return identi.identificacion === _this3.caracData.identificacion;
                      });

                      _this3.vectorJefes.push({
                        index: indice,
                        identificacion: _this3.caracData.identificacion
                      });
                        ...
                        case 0:
                          ...
                          return _Servicios_caracterizacion_servicios__WEBPACK_IMPORTED_MODULE_1__["validarJefe"](parametros).then(function (respuesta) {
                            if (respuesta.data.OPC == "EXISTE") {
                              ...
                              _this4.$swal("Validar...!", "El Documento <b>" + iden + "</b> De La Fila <b>" + (i + 1) + "</b> Se Encuentra Registrado", "warning"); // item.identificacion="";


                              return false;
                            } else {
                              // VERIFICAR SI ESTA EN LA TABLA
                              var resultado = _this4.datos.filter(function (identi) {
                                return identi.identificacion.includes(_this4.datos[i].identificacion);
                              }); // VERIFICAR SI ESTA EN LA TABLA


                              if (resultado.length > 1) {
                                _this4.$swal("Validar...!", "El Documento <b>" + _this4.datos[i].identificacion + "</b> De La Fila <b>" + (i + 1) + "</b>  Se Encuentra Agregado En La Tabla de Integrantes", "warning"); // item.identificacion="";


                                return false;
                              } else {
                                if (_this4.datos[i].tipo_id === "0") {
                                  _this4.$swal("Error...!", "Por favor seleccione un <b>tipo de identificación</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this4.datos[i].identificacion === "") {
                                  _this4.$swal("Error...!", "Por favor digite una <b>identificación</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this4.datos[i].pnom === "") {
                                  _this4.$swal("Error...!", "Por favor digite el <b>primer nombre</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this4.datos[i].pape === "") {
                                  _this4.$swal("Error...!", "Por favor digite el <b>primer apellido</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this4.datos[i].sexo === "0") {
                                  _this4.$swal("Error...!", "Por favor seleccione el <b>sexo</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this4.datos[i].parentesco === "0") {
                                  _this4.$swal("Error...!", "Por favor seleccione el <b>parentesco</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this4.datos[i].estado_civil === "0") {
                                  _this4.$swal("Error...!", "Por favor seleccione el <b>estado civil</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this4.datos[i].fecha_nac === "") {
                                  _this4.$swal("Error...!", "Por favor seleccione la <b>fecha de nacimiento</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this4.datos[i].afi_entidad === "0") {
                                  _this4.$swal("Error...!", "Por favor seleccione la <b>eps</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this4.datos[i].tipo_afiliacion === "0") {
                                  _this4.$swal("Error...!", "Por favor seleccione el <b>tipo de afiliación</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this4.datos[i].escolaridad === "0") {
                                  _this4.$swal("Error...!", "Por favor seleccione el <b>nivel de escolaridad</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this4.datos[i].ocupacion === "0") {
                                  _this4.$swal("Error...!", "Por favor seleccione la <b>ocupación</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this4.datos[i].etnia === "0") {
                                  _this4.$swal("Error...!", "Por favor seleccione la <b>etnia</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this4.datos[i].clasificacion === "0") {
                                  _this4.$swal("Error...!", "Por favor seleccione la <b>clasificacion de la etnia</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this4.datos[i].jefe === "0") {
                                  _this4.$swal("Error...!", "Por favor seleccione el <b>jefe de hogar</b> en la fila " + (i + 1) + " de los integrantes", "error");
                        ...
                        case 0:
                          ...
                          return _Servicios_caracterizacion_servicios__WEBPACK_IMPORTED_MODULE_1__["validarJefe"](parametros).then(function (respuesta) {
                            if (respuesta.data.OPC == "EXISTE") {
                              ...
                              _this5.$swal("Validar...!", "El Documento <b>" + iden + "</b> De La Fila <b>" + (i + 1) + "</b> Se Encuentra Registrado", "warning"); // item.identificacion="";


                              return false;
                            } else {
                              // VERIFICAR SI ESTA EN LA TABLA
                              var resultado = _this5.datosJefe.filter(function (identi) {
                                return identi.identificacion.includes(_this5.datosJefe[i].identificacion);
                              }); // VERIFICAR SI ESTA EN LA TABLA


                              if (resultado.length > 1) {
                                _this5.$swal("Validar...!", "El Documento <b>" + _this5.datosJefe[i].identificacion + "</b> De La Fila <b>" + (i + 1) + "</b>  Se Encuentra Agregado En La Tabla de Jefes de Hogar", "warning"); // item.identificacion="";


                                return false;
                              } else {
                                if (_this5.datosJefe[i].tipo_id === "") {
                                  _this5.$swal("Error...!", "Por favor seleccione un <b>tipo de identificación</b> en la fila " + (i + 1) + " de los jefes de hogar", "error");

                                  return false;
                                }

                                if (_this5.datosJefe[i].identificacion === "") {
                                  _this5.$swal("Error...!", "Por favor digite una <b>identificación</b> en la fila " + (i + 1) + " de los jefes de hogar", "error");

                                  return false;
                                }

                                if (_this5.datosJefe[i].pnom === "") {
                                  _this5.$swal("Error...!", "Por favor digite el <b>primer nombre</b> en la fila " + (i + 1) + " de los jefes de hogar", "error");

                                  return false;
                                }

                                if (_this5.datosJefe[i].pape === "") {
                                  _this5.$swal("Error...!", "Por favor digite el <b>primer apellido</b> en la fila " + (i + 1) + " de los jefes de hogar", "error");

                                  return false;
                                }

                                if (_this5.datosJefe[i].sexo === "") {
                                  _this5.$swal("Error...!", "Por favor seleccione el <b>sexo</b> en la fila " + (i + 1) + " de los jefes de hogar", "error");

                                  return false;
                                }

                                if (_this5.datosJefe[i].parentesco === "") {
                                  _this5.$swal("Error...!", "Por favor seleccione el <b>parentesco</b> en la fila " + (i + 1) + " de los jefes de hogar", "error");

                                  return false;
                                }

                                if (_this5.datosJefe[i].estado_civil === "") {
                                  _this5.$swal("Error...!", "Por favor seleccione el <b>estado civil</b> en la fila " + (i + 1) + " de los jefes de hogar", "error");

                                  return false;
                                }

                                if (_this5.datosJefe[i].fecha_nacimiento === "") {
                                  _this5.$swal("Error...!", "Por favor seleccione la <b>fecha de nacimiento</b> en la fila " + (i + 1) + " de los jefes de hogar", "error");

                                  return false;
                                }

                                if (_this5.datosJefe[i].afiliacion_entidad === "") {
                                  _this5.$swal("Error...!", "Por favor seleccione la <b>eps</b> en la fila " + (i + 1) + " de los jefes de hogar", "error");

                                  return false;
                                }

                                if (_this5.datosJefe[i].tipo_afiliacion === "") {
                                  _this5.$swal("Error...!", "Por favor seleccione el <b>tipo de afiliación</b> en la fila " + (i + 1) + " de los jefes de hogar", "error");

                                  return false;
                                }

                                if (_this5.datosJefe[i].nivel_escolaridad === "") {
                                  _this5.$swal("Error...!", "Por favor seleccione el <b>nivel de escolaridad</b> en la fila " + (i + 1) + " de los jefes de hogar", "error");

                                  return false;
                                }

                                if (_this5.datosJefe[i].ocupacion === "") {
                                  _this5.$swal("Error...!", "Por favor seleccione la <b>ocupación</b> en la fila " + (i + 1) + " de los jefes de hogar", "error");

                                  return false;
                                }

                                if (_this5.datosJefe[i].etnia === "") {
                                  _this5.$swal("Error...!", "Por favor seleccione la <b>etnia</b> en la fila " + (i + 1) + " de los jefes de hogar", "error");

                                  return false;
                                }

                                if (_this5.datosJefe[i].clasificacion === "") {
                                  _this5.$swal("Error...!", "Por favor seleccione la <b>clasificacion de la etnia</b> en la fila " + (i + 1) + " de los jefes de hogar", "error");

                                  return false;
                                }

                                if (_this5.datosJefe[i].salario === "") {
                                  _this5.$swal("Error...!", "Por favor digite el <b>salario</b> en la fila " + (i + 1) + " de los jefes de hogar", "error");
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 15:
                ...
                return _Servicios_caracterizacion_servicios__WEBPACK_IMPORTED_MODULE_1__["guardar"](parametros).then(function (respuesta) {
                  ...
                  if (respuesta.data.OPC == "SI") {
                    ...
                    _this6.$swal("Guardar...!", "Datos Guardados Exitosamente!", "success");

                    _this6.$router.push("/gestion");
                  }
                  ...
                  if (respuesta.data.OPC == "VALIDAR") {
                    ...
                    _this6.$swal("Validar...!", "El Documento <b>" + iden + "</b> Se Encuentra Registrado", "success");
                  }
                })["catch"](function (error) {
              ...
              case 23:
                ...
                _context8.next = _context8.t1 === 419 ? 28 : _context8.t1 === 422 ? 30 : 32;
                break;
    ...
    cambiarCombo: function () {
      ...
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee7(caja) {
        var _this7 = this;
            ...
            switch (_context9.prev = _context9.next) {
              case 0:
                ...
                return _Servicios_barrios_servicios__WEBPACK_IMPORTED_MODULE_2__["comboBarrios"](parametros).then(function (respuesta) {
                  _this7.barrio_options = respuesta.data.arrayBarrios;
                });
              ...
              case 11:
                ...
                _context9.next = _context9.t1 === 422 ? 16 : 18;
                break;
              ...
              case 30:
                ...
                _context9.t3 = _context9.t2.response.status;
                _context9.next = _context9.t3 === 422 ? 35 : 37;
                break;
