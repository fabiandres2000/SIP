...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    pulsa: function pulsa() {
      moment.locale('es');
      console.log(this.fecha_ultima);
      var fechaDividida = this.fecha_ultima.split("-");
      console.log(fechaDividida); // let fecha=moment.utc([fechaDividida[0],fechaDividida[1],fechaDividida[2]]);

      var fecha = moment(this.fecha_ultima, "this.fecha_ultima");
