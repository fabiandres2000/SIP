...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    agregar: function agregar() {
      ...
      this.datos.push((_this$datos$push = {
        dpto: this.corregimientosData.dpto,
        dptoTexto: this.corregimientosData.dpto.texto
      }, _defineProperty(_this$datos$push, "dptoTexto", this.showText(this.veredasData.corregimiento, this.corregi_options[this.veredasData.muni])), _defineProperty(_this$datos$push, "muni", this.corregimientosData.muni), _defineProperty(_this$datos$push, "muniTexto", this.corregimientosData.muni.texto), _defineProperty(_this$datos$push, "corregimiento", this.corregimientosData.corregimiento), _this$datos$push));
      this.corregimientosData.corregimiento = "";
    },
