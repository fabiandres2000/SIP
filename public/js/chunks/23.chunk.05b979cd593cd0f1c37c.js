...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    pulsa: function pulsa() {
      moment.locale("es");
      console.log(this.fecha_ultima); // let fechaDividida = this.fecha_ultima.split("-");
      // console.log(fechaDividida);
      // let fecha=moment.utc([fechaDividida[0],fechaDividida[1],fechaDividida[2]]);

      var fecha = moment.utc(this.fecha_ultima, "YYYY-MM-DD");
      console.log(fecha.format("DD/MM/YYYY"));
      var suma = fecha.add(9, "months");
      console.log(suma.format("DD/MM/YYYY")); // let resta = fecha.subtract(3, "months");
      // console.log(resta.format("DD/MM/YYYY"));
    }
  }
});
      ...
      directives: [
        {
          name: "model",
          rawName: "v-model",
          value: _vm.fecha_ultima,
          expression: "fecha_ultima"
        }
      ],
      staticClass: "form-control text-capitalize",
      class: _vm.fecha_ultima == "" ? "is-invalid" : "is-valid",
      attrs: { id: "date", type: "date" },
      domProps: { value: _vm.fecha_ultima },
      on: {
        input: function($event) {
          if ($event.target.composing) {
            return
          }
          _vm.fecha_ultima = $event.target.value
        }
      }
    }),
    _vm._v(" "),
    _c("a", { staticClass: "btn btn-info", on: { click: _vm.pulsa } }, [
      _vm._v("pulsar")
    ])
  ])
}
