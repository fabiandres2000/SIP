  ...
  methods: {
    cambiarTab1: function cambiarTab1(opcion, actual) {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
        var bandera, resul, i, val, iden, _resul, _i, val1, iden1, parametros, isInvalid, _parametros, _resul2, _resul3, _resul4, _resul5, _resul6, _parametros2, _resul7, _resul8, _resul9, _parametros3, _resul10, _resul11, _resul12, _resul13, _parametros4, _resul14;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                if (!(_this.GIDEN === false)) {
                  _context.next = 85;
                  break;
                }

                if (!(_this.hogar.id_dpto === "")) {
                  _context.next = 7;
                  break;
                }

                _this.$refs.id_dpto.focus();

                _this.$swal("Error...!", "Por favor seleccione el departamento!", "error");

                return _context.abrupt("return");

              case 7:
                if (!(_this.hogar.id_mun === "")) {
                  _context.next = 11;
                  break;
                }

                _this.$refs.id_mun.focus();

                _this.$swal("Error...!", "Por favor seleccione el municipio!", "error");

                return _context.abrupt("return");

              case 11:
                if (!(_this.hogar.tenencia_vivienda === "")) {
                  _context.next = 15;
                  break;
                }

                _this.$refs.tenencia_vivienda.focus();

                _this.$swal("Error...!", "Por favor seleccione la tenencia de vivienda!", "error");

                return _context.abrupt("return");

              case 15:
                if (!(_this.allLetter(_this.hogar.numero_hogares) === false)) {
                  _context.next = 20;
                  break;
                }

                _this.$refs.numero_hogares.focus();

                _this.hogar.numero_hogares = "";

                _this.$swal("Error...!", "Por favor digite solo numero en el numero de hogares!", "error");

                return _context.abrupt("return");

              case 20:
                if (!(_this.hogar.numero_hogares === "")) {
                  _context.next = 24;
                  break;
                }
                ...
                _this.$swal("Error...!", "Por favor digite el numero de hogares!", "error");

                return _context.abrupt("return");

              case 24:
                if (!(_this.hogar.poblacion_especial === "")) {
                  _context.next = 28;
                  break;
                }

                _this.$refs.poblacion_especial.focus();

                _this.$swal("Error...!", "Por favor seleccione la población especial!", "error");

                return _context.abrupt("return");

              case 28:
                if (!(_this.hogar.vias_acceso === "")) {
                  _context.next = 32;
                  break;
                }

                _this.$refs.vias_acceso.focus();

                _this.$swal("Error...!", "Por favor seleccione si la comunidad presenta vías de acceso!", "error");

                return _context.abrupt("return");

              case 32:
                if (!(_this.hogar.servicios_publicos === "")) {
                  _context.next = 36;
                  break;
                }

                _this.$refs.servicios_publicos.focus();

                _this.$swal("Error...!", "Por favor seleccione si presenta acceso fácil a los servicios públicos!", "error");

                return _context.abrupt("return");

              case 36:
                if (!(_this.hogar.direccion === "")) {
                  _context.next = 40;
                  break;
                }

                _this.$refs.direccion.focus();

                _this.$swal("Error...!", "Por favor digite la dirección!", "error");

                return _context.abrupt("return");

              case 40:
                if (!(_this.datosJefe.length <= 0)) {
                  _context.next = 45;
                  break;
                }

                _this.$swal("Error...!", "Por favor agregue por lo menos un jefe de hogar", "error");
              ...
              case 51:
                _this.vectorAyuda = [];
                _context.next = 54;
                return _this.valJef2();

              case 54:
                if (_this.vectorAyuda.length > 0) {
                  for (i = 0; i < _this.vectorAyuda.length; i++) {
                    if (_this.vectorAyuda[i].error === "ERROR1") {
                      val = (_this.vectorAyuda[i].identificacion / 1).toFixed(0).replace(".", ",");
                      iden = val.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".");

                      _this.$swal("Validar...!", "El Documento <b>" + iden + "</b> De La Fila <b>" + (i + 1) + "</b> Se Encuentra Registrado", "warning");
              ...
              case 62:
                _this.vectorAyuda = [];
                _context.next = 65;
                return _this.valInt2();

              case 65:
                if (_this.vectorAyuda.length > 0) {
                  for (_i = 0; _i < _this.vectorAyuda.length; _i++) {
                    if (_this.vectorAyuda[_i].error === "ERROR1") {
                      val1 = (_this.vectorAyuda[_i].identificacion / 1).toFixed(0).replace(".", ",");
                      iden1 = val1.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".");

                      _this.$swal("Validar...!", "El Documento <b>" + iden1 + "</b> De La Fila <b>" + (_i + 1) + "</b> Se Encuentra Registrado En Los Integrantes", "warning");
              ...
              case 66:
                ...
                parametros = {
                  _token: _this.csrf,
                  hogar: _this.hogar,
                  caracterizacion: _this.datosJefe,
                  integrantes: _this.datos,
                  opcion: "GUARDAR",
                  opc: "GUAINDEN"
                };
                _context.prev = 67;
                ...
                return _Servicios_caracterizacion_servicios__WEBPACK_IMPORTED_MODULE_1__["guardar"](parametros).then(function (respuesta) {
                  if (respuesta.data.OPC == "SI") {
                    _this.GIDEN = true;
                    _this.IDHOGAR = respuesta.data.IDHOGAR;
                  }
                })["catch"](function (error) {
                  _this.errorDevuelto = error.response.data.errors;
                  _this.entrarPorError = true;

                  _this.$swal("Error...!", "No se pudo guardar los datos de la pestaña investigación", "error");
              ...
              case 72:
                ...
                _context.next = _context.t1 === 419 ? 77 : _context.t1 === 422 ? 79 : 81;
                break;
              ...
              case 86:
                ...
                if (!(_this.GVIVI === false && _this.GIDEN === true && _this.IDHOGAR !== 0)) {
                  _context.next = 117;
                  break;
                }
                ...
                _this.$swal("Error...!", "Por Favor Complete Los Campos Obligatorios de la Pestaña Vivienda", "error");

                return _context.abrupt("return", false);

              case 95:
                if (!(_this.estratificacion.length <= 0)) {
                  _context.next = 98;
                  break;
                }

                _this.$swal("Error...!", "Por favor agregue por lo menos una estratificación", "error");
              ...
              case 98:
                ...
                _parametros = {
                  _token: _this.csrf,
                  vivienda: _this.viviendaData,
                  estratificacion: _this.estratificacion,
                  Animales: _this.animalesData,
                  opcion: "GUARDAR",
                  opc: "GUAVIVI",
                  IDHOGAR: _this.IDHOGAR
                };
                _context.prev = 99;
                _context.next = 102;
                return _Servicios_caracterizacion_servicios__WEBPACK_IMPORTED_MODULE_1__["guardar"](_parametros).then(function (respuesta) {
                  ...
                  _this.$swal("Error...!", "No se pudo guardar los datos de la pestaña vivienda", "error");
              ...
              case 104:
                ...
                _context.next = _context.t3 === 419 ? 109 : _context.t3 === 422 ? 111 : 113;
                break;
              ...
              case 118:
                ...
                if (!(_this.GCARXCI === false && _this.IDHOGAR !== 0 && _this.GVIVI === true)) {
                  _context.next = 174;
                  break;
                }

                if (!(_this.Men1A.length > 0)) {
                  _context.next = 127;
                  break;
                }

                _resul2 = _this.valMen1();
              ...
              case 127:
                if (!(_this.De1A5.length > 0)) {
                  _context.next = 134;
                  break;
                }

                _resul3 = _this.valDe1A5();
              ...
              case 134:
                if (!(_this.De6A11.length > 0)) {
                  _context.next = 141;
                  break;
                }

                _resul4 = _this.valDe6A11();
              ...
              case 141:
                if (!(_this.De10A59.length > 0)) {
                  _context.next = 148;
                  break;
                }

                _resul5 = _this.valDe10A59();
              ...
              case 148:
                if (!(_this.ParPost.length > 0)) {
                  _context.next = 155;
                  break;
                }

                _resul6 = _this.valParPost();
              ...
              case 155:
                ...
                _parametros2 = {
                  ...
                  De1A5: _this.De1A5,
                  De6A11: _this.De6A11,
                  De10A59: _this.De10A59,
                  ParPost: _this.ParPost,
                  opcion: "GUARDAR",
                  opc: "GUACARCI",
                  IDHOGAR: _this.IDHOGAR
                };
                ...
                return _Servicios_caracterizacion_servicios__WEBPACK_IMPORTED_MODULE_1__["guardar"](_parametros2).then(function (respuesta) {
                  ...
                  _this.$swal("Error...!", "No se pudo guardar los datos de la pestaña ciclos", "error");
              ...
              case 161:
                _context.prev = 161;
                _context.t4 = _context["catch"](156);
                _context.t5 = _context.t4.response.status;
                _context.next = _context.t5 === 419 ? 166 : _context.t5 === 422 ? 168 : 170;
                break;
              ...
              case 175:
                ...
                if (!(_this.GADOLE === false && _this.IDHOGAR !== 0 && _this.GVIVI === true)) {
                  _context.next = 217;
                  break;
                }

                if (!(_this.De12A17.length > 0)) {
                  _context.next = 184;
                  break;
                }

                _resul7 = _this.valDe12A17();
              ...
              case 184:
                if (!(_this.De18A28.length > 0)) {
                  _context.next = 191;
                  break;
                }

                _resul8 = _this.valDe18A28();
              ...
              case 191:
                if (!(_this.De29A59.length > 0)) {
                  _context.next = 198;
                  break;
                }

                _resul9 = _this.valDe29A59();
              ...
              case 198:
                ...
                _parametros3 = {
                  _token: _this.csrf,
                  De12A17: _this.De12A17,
                  De18A28: _this.De18A28,
                  De29A59: _this.De29A59,
                  opcion: "GUARDAR",
                  opc: "GUADOLE",
                  IDHOGAR: _this.IDHOGAR
                };
              ...
              case 204:
                _context.prev = 204;
                _context.t6 = _context["catch"](199);
                _context.t7 = _context.t6.response.status;
                _context.next = _context.t7 === 419 ? 209 : _context.t7 === 422 ? 211 : 213;
                break;
              ...
              case 218:
                ...
                if (!(_this.GADULT === false && _this.IDHOGAR !== 0 && _this.GVIVI === true)) {
                  _context.next = 267;
                  break;
                }

                if (!(_this.De60.length > 0)) {
                  _context.next = 227;
                  break;
                }

                _resul10 = _this.valDe60();
              ...
              case 234:
                if (!(_this.EnCro.length > 0)) {
                  _context.next = 241;
                  break;
                }

                _resul12 = _this.valEnCro();
              ...
              case 241:
                if (!(_this.EnInf.length > 0)) {
                  _context.next = 248;
                  break;
                }

                _resul13 = _this.valEnInf();
              ...
              case 254:
                _context.prev = 254;
                _context.t8 = _context["catch"](249);
                _context.t9 = _context.t8.response.status;
                _context.next = _context.t9 === 419 ? 259 : _context.t9 === 422 ? 261 : 263;
                break;

              case 259:
                _this.$swal("Error...!", "Ocurrio un error!", "error");

                return _context.abrupt("break", 265);
              ...
              case 268:
                ...
                if (!(_this.GMIGRA === false && _this.IDHOGAR !== 0 && _this.GVIVI === true)) {
                  _context.next = 277;
                  break;
                }
        ...
        }, _callee, null, [[67, 72], [99, 104], [156, 161], [199, 204], [249, 254]]);
      }))();
    },
    //VALIDACIONES
                    ...
                    while (1) {
                      switch (_context2.prev = _context2.next) {
                        case 0:
                          parametros = {
                            _token: _this2.csrf,
                            identificacion: _this2.datosJefe[i].identificacion
                          };
                          _context2.prev = 1;
                          _context2.next = 4;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
                    ...
                    while (1) {
                      switch (_context4.prev = _context4.next) {
                        case 0:
                          parametros = {
                            _token: _this3.csrf,
                            identificacion: _this3.datos[i].identificacion
                          };
                          _context4.prev = 1;
                          _context4.next = 4;
              ...
              case 2:
                ...
                return _context5.delegateYield(_loop2(i), "t0", 4);
    ...
    valDe12A17: function valDe12A17() {
      for (var i = 0; i < this.De12A17.length; i++) {
        ...
        if (this.De12A17[i].conyuge === "") {
          this.$swal("Error...!", "Por favor seleccione la opcion <b>Conyugue</b> en la fila " + (i + 1) + " de la tabla adolescentes de 12 a 17 años", "error");
          return false;
        }
      }
    ...
    //VALIDACIONES DE LOS CICLOS
    //VALIDACIONES
    cambiarTab2: function cambiarTab2(opcion) {// $('.nav-tabs a[href="#' + opcion + '"]').tab('show');
    },
            ...
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                return _Servicios_caracterizacion_servicios__WEBPACK_IMPORTED_MODULE_1__["nuevaCaracterizacion"](parametros).then(function (respuesta) {
                  _this4.dpto_options = respuesta.data.arrayDpto;
                  _this4.muni_options = respuesta.data.arrayMuni;
                  _this4.corregi_options = respuesta.data.arrayCorregi;
                  _this4.vereda_options = respuesta.data.arrayVeredas; // this.barrio_options = respuesta.data.arrayBarrios;

                  _this4.parentesco_options = respuesta.data.arrayParentesco;
                  _this4.estado_options = respuesta.data.arrayEstado;
                  _this4.escolaridad_options = respuesta.data.arrayEscolaridad;
                  _this4.ocupacion_options = respuesta.data.arrayOcupacion;
                  _this4.etnia_options = respuesta.data.arrayEtnia;
                  _this4.admini_options = respuesta.data.arrayAdmini;
                  _this4.clasifi_options = respuesta.data.arrayCLasifi;
                  _this4.grados_option = respuesta.data.arrayGrados;
                });
              ...
              case 6:
                ...
                _context6.next = _context6.t1 === 422 ? 11 : 13;
                break;
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                ...
                return _Servicios_caracterizacion_servicios__WEBPACK_IMPORTED_MODULE_1__["validar"](parametros).then(function (respuesta) {
                  if (respuesta.data.OPC == "EXISTE") {
                    ...
                    _this5.$swal("Validar...!", "El Documento <b>" + iden + "</b> Se Encuentra Registrado", "warning");

                    return false;
                  } else {
                    // VERIFICAR SI ESTA EN LA TABLA
                    var resultado = _this5.datos.filter(function (identi) {
                      return identi.identificacion.includes(_this5.CA1.identificacion);
                    }); // VERIFICAR SI ESTA EN LA TABLA


                    if (resultado.length > 0) {
                      _this5.$swal("Validar...!", "El Documento <b>" + _this5.CA1.identificacion + "</b> Se Encuentra Agregado", "warning");

                      return false;
                    } else {
                      var nacimiento = moment(_this5.CA1.fecha_nac);
                      var hoy = moment();
                      var edad = 0;
                      ...
                      _this5.datos.push({
                        id: 0,
                        tipo_id: _this5.CA1.tipo_id,
                        identificacion: _this5.CA1.identificacion,
                        sexo: _this5.CA1.sexo,
                        parentesco: _this5.CA1.parentesco,
                        textoParentesco: _this5.showText(_this5.CA1.parentesco, _this5.parentesco_options),
                        pnom: _this5.CA1.pnom,
                        snom: _this5.CA1.snom,
                        pape: _this5.CA1.pape,
                        sape: _this5.CA1.sape,
                        estado_civil: _this5.CA1.estado_civil,
                        textoEstado: _this5.showText(_this5.CA1.estado_civil, _this5.estado_options),
                        fecha_nac: _this5.CA1.fecha_nac,
                        edad: edad,
                        afi_entidad: _this5.CA1.afi_entidad,
                        otra_eps: _this5.CA1.otra_eps,
                        tipo_afiliacion: _this5.CA1.tipo_afiliacion,
                        embarazo: _this5.CA1.embarazo,
                        embarazo_multiple: _this5.CA1.embarazo_multiple,
                        discapacidad: _this5.CA1.discapacidad,
                        escolaridad: _this5.CA1.escolaridad,
                        textoEscolaridad: _this5.showText(_this5.CA1.escolaridad, _this5.escolaridad_options),
                        ocupacion: _this5.CA1.ocupacion,
                        textoOcupacion: _this5.showText(_this5.CA1.ocupacion, _this5.ocupacion_options),
                        colegio: _this5.CA1.colegio,
                        grado: _this5.CA1.grado,
                        entiende: _this5.CA1.entiende,
                        migrante: _this5.CA1.migrante,
                        pyp: _this5.CA1.pyp,
                        etnia: _this5.CA1.etnia,
                        textoEtnia: _this5.showText(_this5.CA1.etnia, _this5.etnia_options),
                        clasificacion: _this5.CA1.clasificacion,
                        puntaje_sisben: _this5.CA1.puntaje_sisben,
                        jefe: _this5.CA1.jefe
                      });

                      var indice = _this5.datos.findIndex(function (identi) {
                        return identi.identificacion === _this5.CA1.identificacion;
                      });

                      _this5.vectorIntegrante.push({
                        index: indice,
                        identificacion: _this5.CA1.identificacion
                      });

                      _this5.CA1.id = "INTE"; // AGREGAR NIÑOS MENORES DE 1 AÑO

                      if (edad <= 0) {
                        _this5.Amenores1Anio(_this5.CA1);
                      } // AGREGAR NIÑOS MENORES DE 1 AÑO
                      // AGREGAR DE 1 A 5 AÑOS


                      if (edad >= 1 && edad <= 5) {
                        _this5.Ade1a5Anio(_this5.CA1, edad);
                      } // AGREGAR DE 1 A 5 AÑOS
                      // AGREGAR DE 6 A 11 AÑOS


                      if (edad >= 6 && edad <= 11) {
                        _this5.Ade6a11Anio(_this5.CA1, edad);
                      } // AGREGAR DE 6 A 11 AÑOS
                      // AGREGAR DE 10 A 59 AÑOS


                      if (edad >= 10 && edad <= 59) {
                        _this5.Ade10a59Anio(_this5.CA1, edad);
                      } // AGREGAR DE 10 A 59 AÑOS
                      // AGREGAR PARTO POSTPARTO
                      // alert(this.CA1.embarazo_multiple);


                      if (_this5.CA1.embarazo === "SI") {
                        _this5.AParPost(_this5.CA1, edad);
                      } // AGREGAR PARTO POSTPARTO
                      // AGREGAR DE 12 A 17 AÑOS


                      if (edad >= 12 && edad <= 17) {
                        _this5.Ade12a17Anio(_this5.CA1, edad);
                      } // AGREGAR DE 12 A 17 AÑOS
                      // AGREGAR DE 18 A 28 AÑOS


                      if (edad >= 18 && edad <= 28) {
                        _this5.Ade18a28Anio(_this5.CA1, edad);
                      } // AGREGAR DE 18 A 28 AÑOS
                      // AGREGAR DE 29 A 59 AÑOS


                      if (edad >= 29 && edad <= 59) {
                        _this5.Ade29a59Anio(_this5.CA1, edad);
                      } // AGREGAR DE 29 A 59 AÑOS
                      // AGREGAR DE 60 ó MAS AÑOS


                      if (edad >= 60) {
                        _this5.Ade60Anio(_this5.CA1, edad);
                      } // AGREGAR DE 60 ó MAS AÑOS
                      // AGREGAR MIGRANTES


                      if (_this5.CA1.migrante === "SI") {
                        _this5.AMigra(_this5.CA1, edad);
                      } // AGREGAR MIGRANTES
              ...
              case 7:
                ...
                _context7.next = _context7.t1 === 419 ? 12 : _context7.t1 === 422 ? 14 : 16;
                break;
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
                ...
                return _Servicios_caracterizacion_servicios__WEBPACK_IMPORTED_MODULE_1__["validarJefe"](parametros).then(function (respuesta) {
                  if (respuesta.data.OPC == "EXISTE") {
                    ...
                    var resultado = _this6.datosJefe.filter(function (identi) {
                      return identi.identificacion.includes(_this6.caracData.identificacion);
                    }); // VERIFICAR SI ESTA EN LA TABLA
                    ...
                    if (resultado.length) {
                      ...
                      var nacimiento = moment(_this6.caracData.fecha_nacimiento);
                      var hoy = moment();
                      var edad = 0;
                      ...
                      _this6.caracData.id = "JEFE"; // AGREGAR DE 10 A 59 AÑOS

                      if (edad >= 10 && edad <= 59) {
                        _this6.Ade10a59Anio(_this6.caracData, edad);
                      } // AGREGAR DE 10 A 59 AÑOS
                      // AGREGAR PARTO POSTPARTO
                      // alert(this.CA1.embarazo_multiple);
                      ...
                      if (_this6.caracData.embarazo === "SI") {
                        _this6.AParPost(_this6.caracData, edad);
                      } // AGREGAR PARTO POSTPARTO
                      // AGREGAR DE 12 A 17 AÑOS


                      if (edad >= 12 && edad <= 17) {
                        _this6.Ade12a17Anio(_this6.caracData, edad);
                      } // AGREGAR DE 12 A 17 AÑOS
                      // AGREGAR DE 18 A 28 AÑOS


                      if (edad >= 18 && edad <= 28) {
                        _this6.Ade18a28Anio(_this6.caracData, edad);
                      } // AGREGAR DE 18 A 28 AÑOS
                      // AGREGAR DE 29 A 59 AÑOS


                      if (edad >= 29 && edad <= 59) {
                        _this6.Ade29a59Anio(_this6.caracData, edad);
                      } // AGREGAR DE 29 A 59 AÑOS
                      // AGREGAR DE 60 ó MAS AÑOS


                      if (edad >= 60) {
                        _this6.Ade60Anio(_this6.caracData, edad);
                      } // AGREGAR DE 60 ó MAS AÑOS
                      // AGREGAR MIGRANTES


                      if (_this6.caracData.migrante === "SI") {
                        _this6.AMigra(_this6.caracData, edad);
                      } // AGREGAR MIGRANTES
              ...
              case 8:
                ...
                this.errorDevuelto = _context8.t0.response.data.errors;
    ...
    validarTablaIntegrantes: function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee7() {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee7$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
                ...
                _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _loop3(i) {
                  var parametros;
                  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _loop3$(_context9) {
                    while (1) {
                      switch (_context9.prev = _context9.next) {
                        case 0:
                          parametros = {
                            _token: _this7.csrf,
                            identificacion: _this7.datos[i].identificacion
                          };
                          _context9.prev = 1;
                          _context9.next = 4;
                          return _Servicios_caracterizacion_servicios__WEBPACK_IMPORTED_MODULE_1__["validarJefe"](parametros).then(function (respuesta) {
                            if (respuesta.data.OPC == "EXISTE") {
                              ...
                              var resultado = _this7.datos.filter(function (identi) {
                                return identi.identificacion.includes(_this7.datos[i].identificacion);
                              }); // VERIFICAR SI ESTA EN LA TABLA


                              if (resultado.length > 1) {
                                _this7.$swal("Validar...!", "El Documento <b>" + _this7.datos[i].identificacion + "</b> De La Fila <b>" + (i + 1) + "</b>  Se Encuentra Agregado En La Tabla de Integrantes", "warning"); // item.identificacion="";


                                return false;
                              } else {
                                if (_this7.datos[i].tipo_id === "0") {
                                  _this7.$swal("Error...!", "Por favor seleccione un <b>tipo de identificación</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this7.datos[i].identificacion === "") {
                                  _this7.$swal("Error...!", "Por favor digite una <b>identificación</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this7.datos[i].pnom === "") {
                                  _this7.$swal("Error...!", "Por favor digite el <b>primer nombre</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this7.datos[i].pape === "") {
                                  _this7.$swal("Error...!", "Por favor digite el <b>primer apellido</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this7.datos[i].sexo === "0") {
                                  _this7.$swal("Error...!", "Por favor seleccione el <b>sexo</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this7.datos[i].parentesco === "0") {
                                  _this7.$swal("Error...!", "Por favor seleccione el <b>parentesco</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this7.datos[i].estado_civil === "0") {
                                  _this7.$swal("Error...!", "Por favor seleccione el <b>estado civil</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this7.datos[i].fecha_nac === "") {
                                  _this7.$swal("Error...!", "Por favor seleccione la <b>fecha de nacimiento</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this7.datos[i].afi_entidad === "0") {
                                  _this7.$swal("Error...!", "Por favor seleccione la <b>eps</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this7.datos[i].tipo_afiliacion === "0") {
                                  _this7.$swal("Error...!", "Por favor seleccione el <b>tipo de afiliación</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this7.datos[i].escolaridad === "0") {
                                  _this7.$swal("Error...!", "Por favor seleccione el <b>nivel de escolaridad</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this7.datos[i].ocupacion === "0") {
                                  _this7.$swal("Error...!", "Por favor seleccione la <b>ocupación</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this7.datos[i].etnia === "0") {
                                  _this7.$swal("Error...!", "Por favor seleccione la <b>etnia</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this7.datos[i].clasificacion === "0") {
                                  _this7.$swal("Error...!", "Por favor seleccione la <b>clasificacion de la etnia</b> en la fila " + (i + 1) + " de los integrantes", "error");

                                  return false;
                                }

                                if (_this7.datos[i].jefe === "0") {
                                  _this7.$swal("Error...!", "Por favor seleccione el <b>jefe de hogar</b> en la fila " + (i + 1) + " de los integrantes", "error");
              ...
              case 2:
                ...
                return _context10.delegateYield(_loop3(i), "t0", 4);
    ...
    validarTablaJefes: function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee8() {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee8$(_context12) {
          while (1) {
          ...
          while (1) {
            switch (_context13.prev = _context13.next) {
              ...
              case 14:
                ...
                return _Servicios_caracterizacion_servicios__WEBPACK_IMPORTED_MODULE_1__["guardar"](parametros).then(function (respuesta) {
                  ...
                  if (respuesta.data.OPC == "SI") {
                    ...
                    _this9.$swal("Guardar...!", "Datos Guardados Exitosamente!", "success");

                    _this9.$router.push("/gestion");
                  }
                  ...
                  if (respuesta.data.OPC == "VALIDAR") {
                    ...
                    _this9.$swal("Validar...!", "El Documento <b>" + iden + "</b> Se Encuentra Registrado", "success");
                  }
                })["catch"](function (error) {
              ...
              case 22:
                ...
                _context13.next = _context13.t1 === 419 ? 27 : _context13.t1 === 422 ? 29 : 31;
                break;
    ...
    cambiarCombo: function () {
      ...
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee10(caja) {
        var _this10 = this;

        var parametros, _parametros5;
            ...
            switch (_context14.prev = _context14.next) {
              case 0:
                ...
                return _Servicios_barrios_servicios__WEBPACK_IMPORTED_MODULE_2__["comboBarrios"](parametros).then(function (respuesta) {
                  _this10.barrio_options = respuesta.data.arrayBarrios;
                });
              ...
              case 11:
                ...
                _context14.next = _context14.t1 === 422 ? 16 : 18;
                break;
              ...
              case 20:
                ...
                _context14.prev = 25;
                _context14.next = 28;
                return _Servicios_barrios_servicios__WEBPACK_IMPORTED_MODULE_2__["comboBarrios"](_parametros5).then(function (respuesta) {
                  _this10.barrio_options = respuesta.data.arrayBarrios;
                });
              ...
              case 30:
                ...
                _context14.t3 = _context14.t2.response.status;
                _context14.next = _context14.t3 === 422 ? 35 : 37;
                break;
    ...
    updateJefe: function updateJefe(item, valor, opcion, index) {
      ...
      if (opcion === "sexo") {
        ...
        var _indice = this.De10A59.findIndex(function (identi) {
    ...
    changeupdateJefe: function changeupdateJefe(item, event, opcion, index) {
      ...
      if (opcion == "pnom") {
        ...
        var _indice2 = this.De10A59.findIndex(function (identi) {
      ...
      if (opcion == "snom") {
        ...
        var _indice3 = this.De10A59.findIndex(function (identi) {
      ...
      if (opcion == "pape") {
        ...
        var _indice4 = this.De10A59.findIndex(function (identi) {
      ...
      if (opcion == "sape") {
        ...
        var _indice5 = this.De10A59.findIndex(function (identi) {
