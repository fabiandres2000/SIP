          ...
          _c("div", { staticClass: "kt-portlet" }, [
            _c(
              ...
              [
                _c(
                  "a",
                  { staticClass: "m-btn bigicn-only", attrs: { href: "#" } },
                  [_c("i", { staticClass: "m-icon-big-swapright" })]
                ),
                _vm._v(" "),
                _c(
                  "a",
                  {
                    staticClass: "m-btn bigicn-only green",
                    attrs: { href: "#" }
                  },
                  [_c("i", { staticClass: "m-icon-big-swapright icon-white" })]
                )
              ]
            )
          ])
