...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    updateJefe: function updateJefe(item, valor, opcion) {
      if (opcion === "sexo") {
        if (item.sexo === "") {
          item.embarazo = "";
    ...
    changeupdateJefe: function changeupdateJefe(item, event, opcion) {
      if (opcion === "fecha_nacimiento") {
        var nacimiento = moment(event.target.value);
        var hoy = moment();
        var edad = 0;
      ...
      if (opcion == "identificacion") {// item.pb = event.target.value.replace( /[^.\d]/g, '' ).trim();   
      }
    }
  }
});
