          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 4:
                ...
                parametros = {
                  _token: this.csrf,
                  corregimiento: this.corregimientosData,
                  opcion: "EDITAR"
                };
                _context4.prev = 6;
                _context4.next = 9;
                return _Servicios_corregimientos_servicios__WEBPACK_IMPORTED_MODULE_1__["guardarBarrios"](parametros).then(function (respuesta) {
                  _this4.consultar(1);

                  _this4.datos = [];
                  _this4.barriosData.barrio = "";
                  _this4.barriosData.dpto = "";
                  _this4.barriosData.muni = "";
                  _this4.barriosData.corregimiento = "0";
                  _this4.barriosData.id = 0;
