          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 1;
                _context.next = 4;
                return morbinacerServicios.listar(parametros).then(function (respuesta) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 4:
                ...
                _context2.prev = 6;
                _context2.next = 9;
                return morbinacerServicios.guardar(parametros).then(function (respuesta) {
                  _this2.consultar(1);
              ...
              case 0:
                ...
                this.$swal({
                  ...
                  if (result.value) {
                    ...
                    try {
                      morbinacerServicios.eliminar(parametros).then(function (respuesta) {
                        _this3.consultar(1);
