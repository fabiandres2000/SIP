...
class ValoresRiesgosSaludDE1A5 extends Model
{
    ...
    public static function guardarInicial($id_hogar, $alias, $id_inte)
    {
        ...
        return DB::connection('mysql')->table($alias . '.valores_riesgos_salud_de1a5')->Insert([
            'id_hogar' => $id_hogar,
            'alimentacion_saludable_EnIn' => '',
            'asistencia_crecimiento_EnIn' => '',
            'fumigacion_EnIn' => '',
    ...
    {
        $hay = DB::connection('mysql')->table($alias . '.valores_riesgos_salud_de1a5')
        ->where('valores_riesgos_salud_de1a5.id_inte', $id_inte)
        ...
        if ($opcion == "EnIn") {
            return DB::connection('mysql')->table($alias . '.valores_riesgos_salud_de1a5')->where('id_inte', $id_inte)->update([
