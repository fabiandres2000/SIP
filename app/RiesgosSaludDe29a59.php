...
class RiesgosSaludDe29a59 extends Model
{
    protected $table = 'riesgos_salud_de29a59';
    protected $fillable = [
    ...
    public static function guardar($data, $alias)
    {
        ...
        return DB::connection('mysql')->table($alias . '.riesgos_salud_de29a59')->updateOrInsert([
    ...
    public static function modificar($alias, $id_hogar, $opcion, $data, $id_inte)
    {
        ...
        if ($opcion == "EnIn") {
            return DB::connection('mysql')->table($alias . '.riesgos_salud_de29a59')
