      ...
      <div class="kt-portlet__head">
        <div class="kt-portlet__head-label">
          <h3 class="kt-portlet__head-title">
            <span class="kt-widget20__number kt-font-danger">GESTIÓN DE GRUPOS DE AYUDAS</span>
          </h3>
        </div>
      </div>
        ...
        <div class="d-block">
          ...
          <form>
            <div class="form-group row">
              <div class="col-lg-6">
                <label>Grupo de Ayuda:</label>
                <input
                  type="text"
                  class="form-control text-capitalize"
                  placeholder="Descripción"
                  v-model="gruposData.descripcion"
                  :class="gruposClases"
                />
                <div class="invalid-feedback" v-if="gruposError">{{ gruposError }}</div>
              </div>
              <div class="col-lg-6">
                ...
                <input
                  ...
                  v-model="gruposData.observacion"
                />
              </div>
            </div>
            <hr />
...
<script>
  "use strict";
  import * as grupoServicios from "../../Servicios/grupos_servicios";
  export default {
    mounted() {
      this.consultar(1);
    },
    ...
    methods: {
      consultar: async function(pagina) {
        ...
        try {
          await grupoServicios.listar(parametros).then(respuesta => {
            this.grupos = respuesta.data.grupos_ayudas.data;
      ...
      eliminar: async function(usu) {
        ...
        if (usu.estado == "Activo") {
          ...
          titulo =
            "Grupo de ayuda " + usu.descripcion + " activado de manera exitosa";
        }
        this.$swal({
          title: title,
          text: "",
