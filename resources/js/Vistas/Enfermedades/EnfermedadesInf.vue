      ...
      <div class="kt-portlet__head">
        <div class="kt-portlet__head-label">
          <h3 class="kt-portlet__head-title">
            <span class="kt-widget20__number kt-font-danger">GESTIÓN DE ENFERMEDADES INFECCIOSAS</span>
          </h3>
        </div>
      </div>
              ...
              <div class="col-md-12">
                <div class="table-responsive">
                  <table class="table table-sm table-hover">
                    ...
                    <tbody>
                      <tr v-for="(item, index) in enfermedadesinf" :key="index">
            ...
            <div class="form-group row">
              <div class="col-lg-6">
                ...
                <input
                  ...
                  v-model="enfermedadData.descripcion"
                  :class="enfermedadesClases"
                />
                <div class="invalid-feedback" v-if="enfermedadesinfError">{{ enfermedadesinfError }}</div>
              </div>
              <div class="col-lg-6">
                ...
                <input
                  ...
                  v-model="enfermedadData.observacion"
                />
              </div>
            </div>
            <hr />
...
<script>
  "use strict";
  import * as enfermedadServicios from "../../Servicios/enfermedadesInf_servicios";
  export default {
    mounted() {
      this.consultar(1);
    },
    ...
    methods: {
      consultar: async function(pagina) {
        ...
        try {
          await enfermedadServicios.listar(parametros).then(respuesta => {
            this.enfermedadesinf = respuesta.data.enfermedadesinf.data;
      ...
      eliminar: async function(usu) {
        ...
        if (usu.estado == "Activo") {
          ...
          titulo =
            "Enfermedad infecciosa " + usu.descripcion + " activada de manera exitosa";
        }
        this.$swal({
          title: title,
          text: "",
