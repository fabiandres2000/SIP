      ...
      <div class="kt-portlet__head">
        <div class="kt-portlet__head-label">
          <h3 class="kt-portlet__head-title">
            <span class="kt-widget20__number kt-font-danger">GESTIÓN DE ENFERMEDADES CRONICAS</span>
          </h3>
        </div>
      </div>
              ...
              <div class="col-md-12">
                <div class="table-responsive">
                  <table class="table table-sm table-hover">
                    ...
                    <tbody>
                      <tr v-for="(item, index) in enfermedadescro" :key="index">
          ...
          <form>
            <div class="form-group row">
              <div class="col-lg-6">
                ...
                />
                <div class="invalid-feedback" v-if="enfermedadescroError">{{ enfermedadescroError }}</div>
              </div>
              <div class="col-lg-6">
...
<script>
  "use strict";
  import * as enfermedadServicios from "../../Servicios/enfermedadesCro_servicios";
  export default {
    mounted() {
      this.consultar(1);
    },
    ...
    methods: {
      consultar: async function(pagina) {
        ...
        try {
          await enfermedadServicios.listar(parametros).then(respuesta => {
            this.enfermedadescro = respuesta.data.enfermedadescro.data;
      ...
      eliminar: async function(usu) {
        ...
        if (usu.estado == "Activo") {
          ...
          titulo =
            "Enfermedad cronica " + usu.descripcion + " activada de manera exitosa";
        }
        this.$swal({
          title: title,
          text: "",
