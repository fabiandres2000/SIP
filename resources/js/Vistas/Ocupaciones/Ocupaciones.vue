      ...
      <div class="kt-portlet__head">
        <div class="kt-portlet__head-label">
          <h3 class="kt-portlet__head-title">
            <span class="kt-widget20__number kt-font-danger">GESTIÓN DE OCUPACIONES</span>
          </h3>
        </div>
      </div>
              ...
              <div class="col-md-12">
                <div class="table-responsive">
                  <table class="table table-sm table-hover">
                    ...
                    <tbody>
                      <tr v-for="(item, index) in ocupaciones" :key="index">
      ...
      consultar: async function(pagina) {
        ...
        try {
          await ocupacionesServicios
            ...
            .then(respuesta => {
              this.ocupaciones = respuesta.data.ocupaciones.data;
