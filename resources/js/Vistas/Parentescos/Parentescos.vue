      ...
      <div class="kt-portlet__head">
        <div class="kt-portlet__head-label">
          <h3 class="kt-portlet__head-title">
            <span class="kt-widget20__number kt-font-danger">GESTIÓN DE PARENTESCOS</span>
          </h3>
        </div>
      </div>
              ...
              <div class="col-md-12">
                <div class="table-responsive">
                  <table class="table table-sm table-hover">
                    ...
                    <tbody>
                      <tr v-for="(item, index) in parentescos" :key="index">
            ...
            <div class="form-group row">
              <div class="col-lg-4">
                ...
                <input
                  ...
                  v-model="parentescosData.descripcion"
                  :class="parentescosClases"
                />
                <div class="invalid-feedback" v-if="parentescosError">{{ parentescosError }}</div>
              </div>
              <div class="col-lg-8">
                ...
                <input
                  ...
                  v-model="parentescosData.observacion"
                />
              </div>
            </div>
            <hr />
            <div class="text-right">
              <button type="button" class="btn btn-success" @click="guardarParentesco">
...
<script>
  "use strict";
  import * as parentescosServicios from "../../Servicios/parentescos_servicios";
  export default {
    mounted() {
      this.consultar(1);
    },
    ...
    methods: {
      consultar: async function(pagina) {
        ...
        try {
          await parentescosServicios
            .listarParentescos(parametros)
            .then(respuesta => {
              this.parentescos = respuesta.data.parentescos.data;
      ...
      guardarParentesco: async function() {
        if (!this.checkForm()) {
          this.entrarPorError = false;
        } else {
          this.errores = [];
      ...
      eliminar: async function(usu) {
        ...
        if (usu.estado == "Activo") {
          ...
          titulo =
            "Parentesco " + usu.descripcion + " activado de manera exitosa";
        }
        this.$swal({
          title: title,
          text: "",
          ...
          if (result.value) {
            ...
            try {
              parentescosServicios
                .eliminarParentescos(parametros)
                .then(respuesta => {
                  this.consultar(1);
                  this.$swal({
                    position: "top-end",
