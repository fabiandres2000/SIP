                    ...
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title">
                            <span class="kt-widget20__number kt-font-danger"
                                >REPORTE ENFERMEDADES INFECCIOSAS</span
                            >
                        </h3>
                    </div>
...
import * as enfermedadesInf from "../../Servicios/enfermedadesInf_servicios";
import $ from "jquery";
...
export default {
    ...
    methods: { 
        async consultar_enfermedades(){
            await enfermedadesInf.combo().then(respuesta => {
        ...
        async iniciales(){
            ...
            await reportes.inicialesInfecciosas(parametros).then(respuesta => {
                this.integrantes = respuesta.data.integrantes;
                this.crearDataTable()
            });
        },
        crearDataTable() {
            $("#infecciosas_table").dataTable().fnDestroy();
            setTimeout(() => {
                $('#infecciosas_table').DataTable({
                    "lengthChange": true,
                    "ordering": false,
                    "bFilter": false,
                    pageLength : 10,
