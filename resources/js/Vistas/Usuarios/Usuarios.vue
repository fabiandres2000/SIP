    ...
    <div class="kt-portlet" style="margin-top: -4%;">
                      ...
                      <tr v-for="(item, index) in usuarios" :key="index">
                        ...
                        <td style="font-weight: normal;vertical-align: middle;text-align: center;">
                          <span
                            ...
                            :class="item.permi.estado=='Activo'?'kt-badge--success':'kt-badge--danger'"
                        ...
                        <td style="text-align:center;vertical-align: middle;text-align: center;">
                          ...
                          <button
                            ...
                            :class="(item.permi.estado=='Activo'?'btn-outline-danger':'btn-outline-success')"
                            type="button"
                            :title="(item.permi.estado=='Activo')?'Anular':'Activar'"
                            @click="eliminar(item)"
                          >
                            <i class="fa" :class="(item.permi.estado=='Activo')?'fa-trash':'fa-check'"></i>
                          </button>
                        </td>
                      </tr>
                    </tbody>
            ...
            <div class="tab-pane active" id="tabDP" role="tabpanel">
              <form>
                ...
                <div class="form-group row">
                  <div class="col-lg-4">
                    <label>Rol:</label>
                    <b-form-select v-model="permisos.rol" :class="rolClases" @change="cambiarRol('Crear')">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-4" v-show="usuariosData.id == 0">
            ...
            <div class="tab-pane" id="tabP" role="tabpanel">
                      ...
                      <div class="kt-widget4">
                        <div class="kt-widget4__item">
                          <div class="kt-widget4__pic kt-widget4__pic--icon">
                            <span class="kt-badge kt-badge--warning kt-badge--lg">T</span>
                          </div>
                          <a href="#" class="kt-widget4__title">
                            Todos
                          </a>
                          <div class="kt-widget4__pic kt-widget4__pic--icon">
                            <span class="kt-badge kt-badge--brand kt-badge--lg">S</span>
                          </div>
                          <a href="#" class="kt-widget4__title">
                            Sin Permisos
                          </a>
                          <div class="kt-widget4__pic kt-widget4__pic--icon">
                            <span class="kt-badge kt-badge--danger kt-badge--lg">E</span>
                          </div>
                          <a href="#" class="kt-widget4__title">
                            Editar
                          </a>
                          <div class="kt-widget4__pic kt-widget4__pic--icon">
                            <span class="kt-badge kt-badge--primary kt-badge--lg">C</span>
                          </div>
                          <a href="#" class="kt-widget4__title">
                            Crear
                          </a>
                          <div class="kt-widget4__pic kt-widget4__pic--icon">
                            <span class="kt-badge kt-badge--success kt-badge--lg">L</span>
                          </div>
                          <a href="#" class="kt-widget4__title">
                            Lectura
                          </a>                                                                                                              
              ...
              <form class="kt-form">
                <div class="kt-section kt-section--first">
                  <h3 class="kt-section__title">1. Parametros:</h3>
                  <div class="kt-section__body">
                    <div class="form-group row">
                      <label class="col-lg-1 col-form-label">Barrios:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="permisos.barrios" :class="permisos.barrios==''?'is-invalid':'is-valid'">
                      ...
                      <label class="col-lg-1 col-form-label">Usuarios:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="permisos.usuarios" :class="permisos.usuarios==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Corregimientos:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="permisos.corregimientos" :class="permisos.corregimientos==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Etnias:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="permisos.etnias" :class="permisos.etnias==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Ocupaciones:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="permisos.ocupaciones" :class="permisos.ocupaciones==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Parentescos:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="permisos.parentescos" :class="permisos.parentescos==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                    ...
                    <div class="form-group row">
                      <label class="col-lg-1 col-form-label">Estado Civil:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="permisos.estado_civil" :class="permisos.estado_civil==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Escolaridad:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="permisos.escolaridad" :class="permisos.escolaridad==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Veredas:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="permisos.veredas" :class="permisos.veredas==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Mor. en Gestación:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="permisos.morbilidad_ges" :class="permisos.morbilidad_ges==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Mor. al Nacer:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="permisos.morbilidad_nac" :class="permisos.morbilidad_nac==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Met. Planificación:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="permisos.metodos" :class="permisos.metodos==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                    ...
                    <div class="form-group row">
                      <label class="col-lg-1 col-form-label">Mot. no Planificación:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="permisos.motivos" :class="permisos.motivos==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Grupos de Ayuda:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="permisos.grupos" :class="permisos.grupos==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Enf. Cronicas:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="permisos.enfermedades_cro" :class="permisos.enfermedades_cro==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Enf. Infecciosas:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="permisos.enfermedades_inf" :class="permisos.enfermedades_inf==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Religión:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="permisos.religion" :class="permisos.religion==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Colegios:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="permisos.colegios" :class="permisos.colegios==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                    ...
                    <div class="form-group row">
                      <label class="col-lg-1 col-form-label">Act. Economicas:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="permisos.actividades_economicas" :class="permisos.actividades_economicas==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                  ...
                  <h3 class="kt-section__title">2. Caracterización:</h3>
                  <div class="kt-section__body">
                    <div class="form-group row">
                      <label class="col-lg-1 col-form-label">Gestión:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="permisos.gestion" :class="permisos.gestion==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Cons. Integrantes:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="permisos.consulta_integrante" :class="permisos.consulta_integrante==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Cons. Viviendas:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="permisos.consulta_vivienda" :class="permisos.consulta_vivienda==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                    ...
                    <h3 class="kt-section__title">3. Informes:</h3>
                    <div class="form-group row">
                      <label class="col-lg-1 col-form-label">Ind. Gestantes:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="permisos.indicadores_gestantes" :class="permisos.indicadores_gestantes==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Ind. SPA:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="permisos.indicadores_spa" :class="permisos.indicadores_spa==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Dashboard:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="permisos.dashboard" :class="permisos.dashboard==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
      ...
      >
        <div class="d-block">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tabDP1" role="tabpanel">
              <form>
                <div class="form-group row">
                  <div class="col-lg-3">
                    <label>Identificación:</label>
                ...
                <div class="form-group row">
                  <div class="col-lg-4">
                    <label>Rol:</label>
                    <b-form-select class v-model="editarpermisos.rol" :class="rolClases2">
                      <option value selected>Seleccione</option>
                      <option v-for="item in roles" :value="item.value" :key="item.value">{{item.texto}}</option>
                    </b-form-select>
                ...
                <div class="kt-section kt-section--first">
                  ...
                  <div class="kt-section__body">
                    <div class="form-group row">
                      <label class="col-lg-1 col-form-label">Barrios:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="editarpermisos.barrios" :class="editarpermisos.barrios==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Usuarios:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="editarpermisos.usuarios" :class="editarpermisos.usuarios==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Corregimientos:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="editarpermisos.corregimientos" :class="editarpermisos.corregimientos==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Etnias:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="editarpermisos.etnias" :class="editarpermisos.etnias==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Ocupaciones:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="editarpermisos.ocupaciones" :class="editarpermisos.ocupaciones==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Parentescos:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="editarpermisos.parentescos" :class="editarpermisos.parentescos==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                    ...
                    <div class="form-group row">
                      <label class="col-lg-1 col-form-label">Estado Civil:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="editarpermisos.estado_civil" :class="editarpermisos.estado_civil==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Escolaridad:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="editarpermisos.escolaridad" :class="editarpermisos.escolaridad==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Veredas:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="editarpermisos.veredas" :class="editarpermisos.veredas==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Mor. en Gestación:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="editarpermisos.morbilidad_ges" :class="editarpermisos.morbilidad_ges==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Mor. al Nacer:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="editarpermisos.morbilidad_nac" :class="editarpermisos.morbilidad_nac==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Met. Planificación:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="editarpermisos.metodos" :class="editarpermisos.metodos==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                    ...
                    <div class="form-group row">
                      <label class="col-lg-1 col-form-label">Mot. no Planificación:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="editarpermisos.motivos" :class="editarpermisos.motivos==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Grupos de Ayuda:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="editarpermisos.grupos" :class="editarpermisos.grupos==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Enf. Cronicas:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="editarpermisos.enfermedades_cro" :class="editarpermisos.enfermedades_cro==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Enf. Infecciosas:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="editarpermisos.enfermedades_inf" :class="editarpermisos.enfermedades_inf==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Religión:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="editarpermisos.religion" :class="editarpermisos.religion==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Colegios:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="editarpermisos.colegios" :class="editarpermisos.colegios==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                    ...
                    <div class="form-group row">
                      <label class="col-lg-1 col-form-label">Act. Economicas:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="editarpermisos.actividades_economicas" :class="editarpermisos.actividades_economicas==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                  ...
                  <div class="kt-section__body">
                    <div class="form-group row">
                      <label class="col-lg-1 col-form-label">Gestión:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="editarpermisos.gestion" :class="editarpermisos.gestion==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Cons. Integrantes:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="editarpermisos.consulta_integrante" :class="editarpermisos.consulta_integrante==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Cons. Viviendas:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="editarpermisos.consulta_vivienda" :class="editarpermisos.consulta_vivienda==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                    ...
                    <div class="form-group row">
                      <label class="col-lg-1 col-form-label">Ind. Gestantes:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="editarpermisos.indicadores_gestantes" :class="editarpermisos.indicadores_gestantes==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Ind. SPA:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="editarpermisos.indicadores_spa" :class="editarpermisos.indicadores_spa==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
                      ...
                      <label class="col-lg-1 col-form-label">Dashboard:</label>
                      <div class="col-lg-1">
                        <b-form-select v-model="editarpermisos.dashboard" :class="editarpermisos.dashboard==''?'is-invalid':'is-valid'">
                          <option value selected>Sel</option>
                          <option value="L">L</option>
                          <option value="C">C</option>
                          <option value="E">E</option>
    ...
    methods: {
      ...
      guardarUsuario: async function() {
        if (!this.checkForm()) {
          ...
          this.errores = [];
          console.log(this.usuariosData.id);
          const parametros = {
            _token: this.csrf,
        ...
        await usuarioServicios
          ...
          .then(respuesta => {            
            if(respuesta.data.OPC == "SI"){
              ...
              this.usuariosData.identificacion = respuesta.data.usuario.identificacion;
              this.usuariosData.nombre = respuesta.data.usuario.nombre;
              this.usuariosData.email = respuesta.data.usuario.email;
              this.usuariosData.estado = respuesta.data.usuario.estado;
              this.usuariosData.usuario = respuesta.data.usuario.usuario;
              this.usuariosData.celular = respuesta.data.usuario.celular;
              this.usuariosData.direccion = respuesta.data.usuario.direccion;
