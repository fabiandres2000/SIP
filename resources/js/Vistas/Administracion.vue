<template>
  <div>
    <div style="margin-top: -4%;">
      <h4><span class="kt-widget20__number kt-font-primary">Dashboard</span></h4>
      <ul
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane active" id="tabsalud" role="tabpanel">

            </div>

            <div class="tab-pane active" id="tabambientales" role="tabpanel">

            </div>

            <div class="tab-pane active" id="tabsocio" role="tabpanel">

            </div>

            <div class="tab-pane active" id="tabunidades" role="tabpanel">
...
export default {
  ...
  methods: {
    nuevo: async function() {
      ...
      try {
        await administracionServicios.listar(parametros).then(respuesta => {
        ...
        try {
          await administracionServicios.listar(parametros).then(respuesta => {
            this.poblacion = Math.floor(
              (respuesta.data.poblacion / respuesta.data.poblacion) * 100
            );
            this.pob_entrevistadaPor = Math.floor(
              (respuesta.data.totalEntrevistada / respuesta.data.poblacion) *
                100
            );
            this.viviendas = Math.floor(
              (respuesta.data.viviendas / respuesta.data.viviendas) * 100
            );
            this.viv_visitadasPor = Math.floor(
              (respuesta.data.viviendasVisitados / respuesta.data.viviendas) *
                100
            );
