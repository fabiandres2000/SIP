              ...
              <div class="col-md-12">
                <div class="table-responsive">
                  <table class="table table-sm table-hover">
                    ...
                    <tbody>
                      <tr v-for="(item,index) in herramientasData" :key="index" v-show="item.estado=='Activo'">
              ...
              <div class="col-md-12">
                <div class="table-responsive">
                  <table class="table table-sm table-hover">
                    ...
                    <tbody>
                      <tr v-for="(item,index) in utensiliosData" :key="index" v-show="item.estado=='Activo'">
                        <td style="font-weight: normal;vertical-align: middle;">{{ (index+1) }}</td>
                        <td
                          style="font-weight: normal;vertical-align: middle;text-align: left;text-transform:capitalize;"
                        >
              ...
              <div class="col-md-12">
                <div class="table-responsive">
                  <table class="table table-sm table-hover">
                    ...
                    <tbody>
                      <tr v-for="(item,index) in maquinasData" :key="index" v-show="item.estado=='Activo'">
                        <td style="font-weight: normal;vertical-align: middle;">{{ (index+1) }}</td>
                        <td
                          style="font-weight: normal;vertical-align: middle;text-align: left;text-transform:capitalize;"
                        >
              ...
              <div class="col-md-12">
                <div class="table-responsive">
                  <table class="table table-sm table-hover">
                    ...
                    <tbody>
                      <tr v-for="(item,index) in instalacionesData" :key="index" v-show="item.estado=='Activo'">
                        <td style="font-weight: normal;vertical-align: middle;">{{ (index+1) }}</td>
                        <td
                          style="font-weight: normal;vertical-align: middle;text-align: left;text-transform:capitalize;"
                        >
              ...
              <div class="col-md-12">
                <div class="table-responsive">
                  <table class="table table-sm table-hover">
                    ...
                    <tbody>
                      <tr v-for="(item,index) in mediosData" :key="index" v-show="item.estado=='Activo'">
                        <td style="font-weight: normal;vertical-align: middle;">{{ (index+1) }}</td>
                        <td
                          style="font-weight: normal;vertical-align: middle;text-align: left;text-transform:capitalize;"
                        >
      ...
      nuevo: async function(id_hogar, id) {
        ...
        try {
          await unidadesServicios.editar(parametros).then(respuesta => {
            ...
            this.datos.id_mun = respuesta.data.unidades.id_mun.padStart(
              3,
              0
            );
            ...
            this.datos.direccion = "" + respuesta.data.unidades.direccion;
            ...
            this.datos.usuario_editar = "" + respuesta.data.unidades.usuario_editar;

            this.datos.nom_productor = "" + respuesta.data.unidades.nom_productor;
            this.datos.nivel_educativo = "" + respuesta.data.unidades.nivel_educativo;
            this.datos.tipo_id = "" + respuesta.data.unidades.tipo_id;
            this.datos.identificacion = "" + respuesta.data.unidades.identificacion;
            this.datos.nom_finca = "" + respuesta.data.unidades.nom_finca;
            this.datos.hogares_finca = "" + respuesta.data.unidades.hogares_finca;
            this.datos.linea_productiva = "" + respuesta.data.unidades.linea_productiva;
            this.datos.area_total_finca = "" + respuesta.data.unidades.area_total_finca;
            this.datos.distancia_finca = "" + respuesta.data.unidades.distancia_finca;
            this.datos.tenencia_propiedad = "" + respuesta.data.unidades.tenencia_propiedad;

            this.datos.atiende_entrevista = "" + respuesta.data.unidades.atiende_entrevista;
            this.datos.credito_produccion = "" + respuesta.data.unidades.credito_produccion;
            this.mostrarOtro('CP');

            this.datos.fuentes_prestamo = "" + respuesta.data.unidades.fuentes_prestamo;
            this.datos.cual_fuente = "" + respuesta.data.unidades.cual_fuente;
            this.datos.herramientas_produccion = "" + respuesta.data.unidades.herramientas_produccion;
            this.datos.vias_acceso = respuesta.data.unidades.vias_acceso==null?'':respuesta.data.unidades.vias_acceso;            
            this.datos.tipos_vias_acceso = respuesta.data.unidades.tipos_vias_acceso==null?'':respuesta.data.unidades.tipos_vias_acceso;
            this.datos.importancias_agricolas = respuesta.data.unidades.importancias_agricolas==null?'':respuesta.data.unidades.importancias_agricolas;
            this.datos.area_produccion = respuesta.data.unidades.area_produccion==null?'':respuesta.data.unidades.area_produccion;
            this.datos.unidad_area_produccion = respuesta.data.unidades.unidad_area_produccion==null?'':respuesta.data.unidades.unidad_area_produccion;

            this.datos.producto = respuesta.data.unidades.producto==null?'':respuesta.data.unidades.producto;
            this.datos.variedad = respuesta.data.unidades.variedad==null?'':respuesta.data.unidades.variedad;
            this.datos.semilla = respuesta.data.unidades.semilla==null?'':respuesta.data.unidades.semilla;
            this.datos.pertenece = respuesta.data.unidades.pertenece==null?'':respuesta.data.unidades.pertenece;
            this.mostrarOtro('P');

            this.datos.tipo_pertenece = respuesta.data.unidades.tipo_pertenece==null?'':respuesta.data.unidades.tipo_pertenece;
            this.datos.nombre_organizacion = respuesta.data.unidades.nombre_organizacion==null?'':respuesta.data.unidades.nombre_organizacion;
            this.datos.beneficios = respuesta.data.unidades.beneficios==null?'':respuesta.data.unidades.beneficios;
            this.datos.no_pertenece = respuesta.data.unidades.no_pertenece==null?'':respuesta.data.unidades.no_pertenece;
            this.datos.trabaja_asociacion = respuesta.data.unidades.trabaja_asociacion==null?'':respuesta.data.unidades.trabaja_asociacion;
            this.datos.frecuente_cosecha = respuesta.data.unidades.frecuente_cosecha==null?'':respuesta.data.unidades.frecuente_cosecha;

            this.datos.area_cosecha = respuesta.data.unidades.area_cosecha==null?'':respuesta.data.unidades.area_cosecha;
            this.datos.unidad_area_cosecha = respuesta.data.unidades.unidad_area_cosecha==null?'':respuesta.data.unidades.unidad_area_cosecha;
            this.datos.costo_produccion = respuesta.data.unidades.costo_produccion==null?'':respuesta.data.unidades.costo_produccion;
            this.datos.costo_establecimiento = respuesta.data.unidades.costo_establecimiento==null?'':respuesta.data.unidades.costo_establecimiento;
            this.datos.costo_sostenimiento = respuesta.data.unidades.costo_sostenimiento==null?'':respuesta.data.unidades.costo_sostenimiento;
            this.datos.produccion_destinada = respuesta.data.unidades.produccion_destinada==null?'':respuesta.data.unidades.produccion_destinada;
            this.datos.tipo_problema = respuesta.data.unidades.tipo_problema==null?'':respuesta.data.unidades.tipo_problema;
            this.mostrarOtro('TPP');

            this.datos.compradores = respuesta.data.unidades.compradores==null?'':respuesta.data.unidades.compradores;
            this.datos.precio_promedio_venta = respuesta.data.unidades.precio_promedio_venta==null?'':respuesta.data.unidades.precio_promedio_venta;
            this.datos.metodo_pago = respuesta.data.unidades.metodo_pago==null?'':respuesta.data.unidades.metodo_pago;

            this.datos.precio_promedio_venta_kg = respuesta.data.unidades.precio_promedio_venta_kg==null?'':respuesta.data.unidades.precio_promedio_venta_kg;
            this.datos.subproductos_produccion = respuesta.data.unidades.subproductos_produccion==null?'':respuesta.data.unidades.subproductos_produccion;
            this.datos.programa_asistencia_tecnica = respuesta.data.unidades.programa_asistencia_tecnica==null?'':respuesta.data.unidades.programa_asistencia_tecnica;
            this.mostrarOtro('PAT');

            this.datos.nombre_programa = respuesta.data.unidades.nombre_programa==null?'':respuesta.data.unidades.nombre_programa;
            this.datos.entidad = respuesta.data.unidades.entidad==null?'':respuesta.data.unidades.entidad;
            this.datos.cambios_produccion_anio = respuesta.data.unidades.cambios_produccion_anio==null?'':respuesta.data.unidades.cambios_produccion_anio;
            this.mostrarOtro('CTI');

            this.datos.actividad_cambio = respuesta.data.unidades.actividad_cambio==null?'':respuesta.data.unidades.actividad_cambio;
            this.datos.importancia_comercial = respuesta.data.unidades.importancia_comercial==null?'':respuesta.data.unidades.importancia_comercial;
            this.datos.raza = respuesta.data.unidades.raza==null?'':respuesta.data.unidades.raza;
            this.datos.costo_total = respuesta.data.unidades.costo_total==null?'':respuesta.data.unidades.costo_total;

            this.datos.costo_establecer = respuesta.data.unidades.costo_establecer==null?'':respuesta.data.unidades.costo_establecer;
            this.datos.costo_pecuaria = respuesta.data.unidades.costo_pecuaria==null?'':respuesta.data.unidades.costo_pecuaria;
            this.datos.problematica_productos = respuesta.data.unidades.problematica_productos==null?'':respuesta.data.unidades.problematica_productos;
            this.mostrarOtro('PPP');

            this.datos.otra_problematica = respuesta.data.unidades.otra_problematica==null?'':respuesta.data.unidades.otra_problematica;
            this.datos.produccion = respuesta.data.unidades.produccion==null?'':respuesta.data.unidades.produccion;
            this.datos.numero_animales = respuesta.data.unidades.numero_animales==null?'':respuesta.data.unidades.numero_animales;
            this.datos.area_destinada_produccion = respuesta.data.unidades.area_destinada_produccion==null?'':respuesta.data.unidades.area_destinada_produccion;
            this.datos.unidad_area_destinada = respuesta.data.unidades.unidad_area_destinada==null?'':respuesta.data.unidades.unidad_area_destinada;
            this.datos.compradores_pecuaria = respuesta.data.unidades.compradores_pecuaria==null?'':respuesta.data.unidades.compradores_pecuaria;
            this.datos.precio_promedio_venta_pecuaria = respuesta.data.unidades.precio_promedio_venta_pecuaria==null?'':respuesta.data.unidades.precio_promedio_venta_pecuaria;

            this.datos.metodo_pago_pecuaria = respuesta.data.unidades.metodo_pago_pecuaria==null?'':respuesta.data.unidades.metodo_pago_pecuaria;
            this.datos.subproductos_produccion_pecuaria = respuesta.data.unidades.subproductos_produccion_pecuaria==null?'':respuesta.data.unidades.subproductos_produccion_pecuaria;
            this.datos.pertenece_pecuaria = respuesta.data.unidades.pertenece_pecuaria==null?'':respuesta.data.unidades.pertenece_pecuaria;
            this.mostrarOtro('PATP');

            this.datos.nombre_programa_pecuaria = respuesta.data.unidades.nombre_programa_pecuaria==null?'':respuesta.data.unidades.nombre_programa_pecuaria;
            this.datos.entidad_pecuaria = respuesta.data.unidades.entidad_pecuaria==null?'':respuesta.data.unidades.entidad_pecuaria;
            this.datos.pertenece_organizacion_pecuaria = respuesta.data.unidades.pertenece_organizacion_pecuaria==null?'':respuesta.data.unidades.pertenece_organizacion_pecuaria;
            this.mostrarOtro('POPECU');

            this.datos.tipo_organizacion_pecuaria = respuesta.data.unidades.tipo_organizacion_pecuaria==null?'':respuesta.data.unidades.tipo_organizacion_pecuaria;
            this.datos.nombre_organizacion_pecuaria = respuesta.data.unidades.nombre_organizacion_pecuaria==null?'':respuesta.data.unidades.nombre_organizacion_pecuaria;
            this.datos.beneficios_pecuaria = respuesta.data.unidades.beneficios_pecuaria==null?'':respuesta.data.unidades.beneficios_pecuaria;
            this.datos.no_pertenece_pecuaria = respuesta.data.unidades.no_pertenece_pecuaria==null?'':respuesta.data.unidades.no_pertenece_pecuaria;

            this.datos.trabaja_asociacion_pecuaria = respuesta.data.unidades.trabaja_asociacion_pecuaria==null?'':respuesta.data.unidades.trabaja_asociacion_pecuaria;
            this.datos.importancia_forestales = respuesta.data.unidades.importancia_forestales==null?'':respuesta.data.unidades.importancia_forestales;
            this.datos.producto_forestales = respuesta.data.unidades.producto_forestales==null?'':respuesta.data.unidades.producto_forestales;
            this.datos.variedad_forestales = respuesta.data.unidades.variedad_forestales==null?'':respuesta.data.unidades.variedad_forestales;
            this.datos.edad_plantacion = respuesta.data.unidades.edad_plantacion==null?'':respuesta.data.unidades.edad_plantacion;
            this.datos.tipo_edad = respuesta.data.unidades.tipo_edad==null?'':respuesta.data.unidades.tipo_edad;
            this.datos.area_sembrada_forestales = respuesta.data.unidades.area_sembrada_forestales==null?'':respuesta.data.unidades.area_sembrada_forestales;
            this.datos.unidad_area_forestales = respuesta.data.unidades.unidad_area_forestales==null?'':respuesta.data.unidades.unidad_area_forestales;
            this.datos.rendimiento_arbol = respuesta.data.unidades.rendimiento_arbol==null?'':respuesta.data.unidades.rendimiento_arbol;
            this.datos.costo_total_forestales = respuesta.data.unidades.costo_total_forestales==null?'':respuesta.data.unidades.costo_total_forestales;

            this.datos.costo_establecimiento_forestales = respuesta.data.unidades.costo_establecimiento_forestales==null?'':respuesta.data.unidades.costo_establecimiento_forestales;
            this.datos.costo_sostenimiento_forestales = respuesta.data.unidades.costo_sostenimiento_forestales==null?'':respuesta.data.unidades.costo_sostenimiento_forestales;
            this.datos.problematica_productos_forestales = respuesta.data.unidades.problematica_productos_forestales==null?'':respuesta.data.unidades.problematica_productos_forestales;
            this.mostrarOtro('PPPF');

            this.datos.produccion_destinada_forestales = respuesta.data.unidades.produccion_destinada_forestales==null?'':respuesta.data.unidades.produccion_destinada_forestales;
            this.datos.numero_arboles = respuesta.data.unidades.produccion_destinada_forestales==null?'':respuesta.data.unidades.produccion_destinada_forestales;
            this.datos.compradores_forestales = respuesta.data.unidades.compradores_forestales==null?'':respuesta.data.unidades.compradores_forestales;
            this.datos.metodo_pago_forestales = respuesta.data.unidades.metodo_pago_forestales==null?'':respuesta.data.unidades.metodo_pago_forestales;
            this.datos.precio_promedio_venta_forestales = respuesta.data.unidades.precio_promedio_venta_forestales==null?'':respuesta.data.unidades.precio_promedio_venta_forestales;
            this.datos.subproductos_produccion_forestales = respuesta.data.unidades.subproductos_produccion_forestales==null?'':respuesta.data.unidades.subproductos_produccion_forestales;
            this.datos.pertenece_forestales = respuesta.data.unidades.pertenece_forestales==null?'':respuesta.data.unidades.pertenece_forestales;
            this.mostrarOtro('PATF');


            this.datos.nombre_programa_forestales = respuesta.data.unidades.nombre_programa_forestales==null?'':respuesta.data.unidades.nombre_programa_forestales;
            this.datos.entidad_forestales = respuesta.data.unidades.entidad_forestales==null?'':respuesta.data.unidades.entidad_forestales;
            this.datos.pertenece_organizacion_forestales = respuesta.data.unidades.pertenece_organizacion_forestales==null?'':respuesta.data.unidades.pertenece_organizacion_forestales;
            this.mostrarOtro('PF');

            this.datos.tipo_pertenece_forestales = respuesta.data.unidades.tipo_pertenece_forestales==null?'':respuesta.data.unidades.tipo_pertenece_forestales;
            this.datos.nombre_organizacion_forestales = respuesta.data.unidades.nombre_organizacion_forestales==null?'':respuesta.data.unidades.nombre_organizacion_forestales;
            this.datos.beneficios_forestales = respuesta.data.unidades.beneficios_forestales==null?'':respuesta.data.unidades.beneficios_forestales;
            this.datos.no_pertenece_forestales = respuesta.data.unidades.no_pertenece_forestales==null?'':respuesta.data.unidades.no_pertenece_forestales;
            this.datos.trabaja_asociacion_forestales = respuesta.data.unidades.trabaja_asociacion_forestales==null?'':respuesta.data.unidades.trabaja_asociacion_forestales;
            this.datos.unidad_area = respuesta.data.unidades.unidad_area==null?'':respuesta.data.unidades.unidad_area;
            this.datos.unidad_distancia = respuesta.data.unidades.unidad_distancia==null?'':respuesta.data.unidades.unidad_distancia;
            this.datos.otro_tipo_problema = respuesta.data.unidades.otro_tipo_problema==null?'':respuesta.data.unidades.otro_tipo_problema;
            this.datos.producto_comercial = respuesta.data.unidades.producto_comercial==null?'':respuesta.data.unidades.producto_comercial;
            this.datos.produccion_destinada_pecuaria = respuesta.data.unidades.produccion_destinada_pecuaria==null?'':respuesta.data.unidades.produccion_destinada_pecuaria;
            this.datos.otros_problematica_productos_forestales = respuesta.data.unidades.otros_problematica_productos_forestales==null?'':respuesta.data.unidades.otros_problematica_productos_forestales;
            ...
            console.log(this.utensiliosData);
          });
        } catch (error) {
