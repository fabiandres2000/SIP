                  ...
                  <table class="table table-sm table-hover">
                    <thead class>
                      <tr class="kt-bg-fill-brand">
                        ...
                        <th class="text-center">Razón por la cual no pertenece a ninguna organización</th>                        
                        <th class="text-center">Trabaja en asociación para realizar las actividades productivas</th>
                        <th class="text-center">Para cada uno de los productos que tan frecuente se hace la cosecha</th>
                        ...
                        <th class="text-center">Durante el último año, ha realizado usted cambios en su producción en temas de innovación</th>
                        <th class="text-center">En qué actividad realizó el cambio</th>
                        <td class="text-center">Opciones</td>
                      </tr>
                    </thead>
                    <tbody>
                      <tr v-for="(item,index) in cultivos_agricolas" :key="index">
                        <td style="font-weight: normal;vertical-align: middle;">{{ (index+1) }}</td>
                        <td
                          style="font-weight: normal;vertical-align: middle;text-align: left;text-transform:capitalize;"
                        >
                  ...
                  <table class="table table-sm table-hover">
                    <thead class>
                      <tr class="kt-bg-fill-brand">
                        ...
                        <th class="text-center">Problemática de los productos con perspectiva comercial</th>
                        <th class="text-center">Otra Problematica de los productos con perspectiva comercial</th>                        
                    ...
                    <tbody>
                      <tr v-for="(item,index) in explotaciones_pecuarias" :key="index">
                        <td style="font-weight: normal;vertical-align: middle;">{{ (index+1) }}</td>
                        <td
                          style="font-weight: normal;vertical-align: middle;text-align: left;text-transform:capitalize;"
                        >
              ...
              <div class="col-md-12">
                <div class="table-responsive">
                  <table class="table table-sm table-hover">
                    ...
                    <tbody>
                      <tr v-for="(item,index) in cultivos_forestales" :key="index">
                        <td style="font-weight: normal;vertical-align: middle;">{{ (index+1) }}</td>
                        <td
                          style="font-weight: normal;vertical-align: middle;text-align: left;text-transform:capitalize;"
                        >
                        ...
                        >
                          <input
                            ...
                            :class="item.nombre_organizacion_forestales==''?'':'is-valid'"
                            readonly
                          />
                        </td>
                        <td
