      ...
      <div class="kt-portlet__body">
        <div class="kt-section">
          <div class="kt-section__content">
            ...
            <div class="form-group row">
              <div class="col-lg-12" v-show="mOMP">
                <label>¿Cual?:</label>
                <input
                  type="text"
                  class="form-control text-capitalize"
            ...
            <div class="form-group row">
              <div class="col-lg-12" v-show="mOTA">
                <label>¿Cual?:</label>
                <input
                  type="text"
                  class="form-control text-capitalize"
            ...
            <div class="form-group row">
              <div class="col-lg-12" v-show="mOPP">
                <label>¿Cual?:</label>
                <input
                  type="text"
                  class="form-control text-capitalize"
...
<script>
  ...
  export default {
    ...
    methods: {
      nuevo: async function(id) {
        const parametros = {
          _token: this.csrf,
          id: id
        };
        try {
          await establecimientosServicios.editar(parametros).then(respuesta => {
            ...
            this.IDHOGAR = respuesta.data.establecimientos.id_hogar;
            this.datos.id = respuesta.data.establecimientos.id;
            this.datos.id_dpto = respuesta.data.establecimientos.id_dpto;
            this.datos.id_mun = respuesta.data.establecimientos.id_mun.padStart(
              3,
              0
            );
            this.cambiarCombo("muni");
            this.datos.id_corre = "" + respuesta.data.establecimientos.id_corre;
            if (this.datos.id_corre !== "0") {
              this.cambiarCombo("corregi");
            }
            this.datos.id_vereda = "" + respuesta.data.establecimientos.id_vereda;
            this.datos.id_barrio = "" + respuesta.data.establecimientos.id_barrio;

            this.datos.registrado =
              "" + respuesta.data.establecimientos.registrado;
            ...
            this.datos.num_matricula =
              "" + respuesta.data.establecimientos.num_matricula;
            this.datos.naturaleza =
              "" + respuesta.data.establecimientos.naturaleza;
            ...
            this.datos.num_empleados =
              "" + respuesta.data.establecimientos.num_empleados;
            this.datos.tiempo_sin_operacion =
              "" + respuesta.data.establecimientos.tiempo_sin_operacion;
            this.datos.tipo_tiempo =
              "" + respuesta.data.establecimientos.tipo_tiempo;
            this.datos.fecha_retorno =
              "" + respuesta.data.establecimientos.fecha_retorno;
            this.datos.promedio_ingresos_anterior =
              "" + respuesta.data.establecimientos.promedio_ingresos_anterior;
            this.datos.promedio_ingresos_durante =
              "" + respuesta.data.establecimientos.promedio_ingresos_durante;
            this.datos.promedio_ingresos_posterior =
              "" + respuesta.data.establecimientos.promedio_ingresos_posterior;
            this.datos.carga_economica =
            ...
            this.datos.tiempo_recuperacion =
              "" + respuesta.data.establecimientos.tiempo_recuperacion;
            this.datos.principal_problema =
              "" + respuesta.data.establecimientos.principal_problema;
            ...
            this.datos.id_compania =
              "" + respuesta.data.establecimientos.id_compania;
            this.datos.fecha = "" + respuesta.data.establecimientos.fecha;
            this.datos.usuario_crear =
              "" + respuesta.data.establecimientos.usuario_crear;
            this.datos.fecha_editar =
              "" + respuesta.data.establecimientos.fecha_editar;
            this.datos.usuario_editar =
              "" + respuesta.data.establecimientos.usuario_editar;
            this.datos.otro_principal_problema =
              "" + respuesta.data.establecimientos.otro_principal_problema;
            this.datos.nit = "" + respuesta.data.establecimientos.nit;
