      ...
      <div class="kt-portlet__head">
        <div class="kt-portlet__head-label">
          <h3 class="kt-portlet__head-title">
            <span class="kt-widget20__number kt-font-danger">GESTIÓN DE ACTIVIDADES ECONOMICAS</span>
          </h3>
        </div>
      </div>
            ...
            <div class="form-group row">
              <div class="col-lg-4">
                ...
                <input
                  ...
                  v-model="actividadesData.descripcion"
                  :class="actividadesData"
                />
                <div class="invalid-feedback" v-if="ocupacionesError">{{ ocupacionesError }}</div>
              </div>
              <div class="col-lg-8">
                ...
                <input
                  ...
                  v-model="actividadesData.observacion"
                />
              </div>
            </div>
            <hr />
