      ...
      <div class="kt-portlet__head">
        <div class="kt-portlet__head-label">
          <h3 class="kt-portlet__head-title">
            <span class="kt-widget20__number kt-font-danger">GESTIÓN DE ESCOLARIDAD</span>
          </h3>
        </div>
      </div>
              ...
              <div class="col-md-12">
                <div class="table-responsive">
                  <table class="table table-sm table-hover">
                    ...
                    <tbody>
                      <tr v-for="(item, index) in escolaridad" :key="index">
            ...
            <div class="form-group row">
              <div class="col-lg-4">
                ...
                <input
                  ...
                  :class="escolaridadClases"
                />
                <div class="invalid-feedback" v-if="escolaridadError">{{ escolaridadError }}</div>
              </div>
              <div class="col-lg-8">
                ...
                <input
                  ...
                  v-model="escolaridadData.observacion"
                />
              </div>
            </div>
            <hr />
            <div class="text-right">
              <button type="button" class="btn btn-success" @click="guardarEscolaridad">
...
<script>
  "use strict";
  import * as escolaridadServicios from "../../Servicios/escolaridad_servicios";
  export default {
    mounted() {
      this.consultar(1);
    },
    ...
    methods: {
      consultar: async function(pagina) {
        ...
        try {
          await escolaridadServicios
            .listarEscolaridad(parametros)
            .then(respuesta => {
              this.escolaridad = respuesta.data.escolaridad.data;
      ...
      guardarEscolaridad: async function() {
        if (!this.checkForm()) {
          this.entrarPorError = false;
        } else {
          this.errores = [];
      ...
      eliminar: async function(usu) {
        ...
        if (usu.estado == "Activo") {
          ...
          titulo =
            "Escolaridad " + usu.descripcion + " anulada de manera exitosa";
        } else {
          title = "¿Desea activar la escolaridad " + usu.descripcion + "?";
          titulo =
            "Escolaridad " + usu.descripcion + " activada de manera exitosa";
        }
        this.$swal({
          title: title,
          text: "",
          ...
          if (result.value) {
            ...
            try {
              escolaridadServicios
                .eliminarEscolaridad(parametros)
                .then(respuesta => {
                  this.consultar(1);
                  this.$swal({
                    position: "top-end",
