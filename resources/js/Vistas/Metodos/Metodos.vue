      ...
      <div class="kt-portlet__head">
        <div class="kt-portlet__head-label">
          <h3 class="kt-portlet__head-title">
            <span class="kt-widget20__number kt-font-danger">GESTIÓN DE METODOS DE PLANIFICACIÓN</span>
          </h3>
        </div>
      </div>
              ...
              <div class="col-md-12">
                <div class="table-responsive">
                  <table class="table table-sm table-hover">
                    ...
                    <tbody>
                      <tr v-for="(item, index) in metodos" :key="index">
        ...
        <div class="d-block">
          ...
          <form>
            <div class="form-group row">
              <div class="col-lg-6">
                <label>Metodo de Planificación:</label>
                <input
                  type="text"
                  class="form-control text-capitalize"
                  placeholder="Descripción"
                  v-model="metodosData.descripcion"
                  :class="metodosClases"
                />
                <div class="invalid-feedback" v-if="metodosError">{{ metodosError }}</div>
              </div>
              <div class="col-lg-6">
                ...
                <input
                  ...
                  v-model="metodosData.observacion"
                />
              </div>
            </div>
            <hr />
...
<script>
  "use strict";
  import * as metodosServicios from "../../Servicios/metodos_servicios";
  export default {
    mounted() {
      this.consultar(1);
    },
    ...
    methods: {
      consultar: async function(pagina) {
        ...
        try {
          await metodosServicios.listar(parametros).then(respuesta => {
            this.metodos = respuesta.data.metodos.data;
      ...
      eliminar: async function(usu) {
        ...
        if (usu.estado == "Activo") {
          ...
          titulo =
            "Metodo de planificación " + usu.descripcion + " activado de manera exitosa";
        }
        this.$swal({
          title: title,
          text: "",
