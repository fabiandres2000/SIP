         ...
         <div ref="document">
            ...
            <div class="row" ref="filtro">
                ...
                <div ref="boton1" class="col-sm-3 col-lg-3 text-right" style="padding: 10px 10px 10px 20px;">
                    <button style="position: absolute;top: 55%;left: 61%;"  @click="exportToPDFAME15()" class="btn btn-danger"><i class="fa fa-file" aria-hidden="true"></i> Exportar PDF</button>
                </div>
            </div>
            <hr>
            <div class="row" ref="grafico1">
                ...
                <div class="col-lg-4 text-center">
                    <br >
                    <h4>Tasa de Analfabetismo (Niños)</h4>
                    <circle-progress
                        stroke-bg-color = "#e3e2e1"
                        :r="80" 
                        :stroke-width="12"  
                ...
                <div class="col-lg-4 text-center">
                    <br >
                    <h4>Tasa de Analfabetismo (Niñas)</h4>
                    <circle-progress
                        stroke-bg-color = "#e3e2e1"
                        :r="80" 
                        :stroke-width="12"  
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="row" ref="hm">
                        ...
                        <div class="col-2"></div>
                        <div class="col-3"><p><span style="background-color: #6794dc">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> Niñas</p></div>
                    </div>
                </div>
                ...
                <div class="col-lg-12 text-right">
                    <button @click="exportToEXCELAME15()" class="btn btn-success">Exportar a excel <i class="fa fa-table" aria-hidden="true"></i></button>
                </div>
            </div>
            <b-modal
                ref="modalpdf"
...
export default {
    ...
    methods: {
        ...
        async estadisticas() {
            ...
            await DashboardServiceSocioeconomico.listarEstadisticaNinios(this.tipo, this.id_combo).then(respuesta => {
        ...
        crearSerie(array){
            this.serie = [
                {
                    age: "1-5",
                    male: Number(((array.analfabetas1_5[0]/(array.analfabetas1_5[0]+array.analfabetas1_5[1]))*100)*-1),
                    female: Number((array.analfabetas1_5[1]/(array.analfabetas1_5[0]+array.analfabetas1_5[1]))*100)
                },
                {
                    age: "6-11",
                    male: Number(((array.analfabetas6_11[0]/(array.analfabetas6_11[0]+array.analfabetas6_11[1]))*100)*-1),
                    female: Number((array.analfabetas6_11[1]/(array.analfabetas6_11[0]+array.analfabetas6_11[1]))*100)
                },
                {
                    age: "12-15",
                    male: Number(((array.analfabetas12_15[0]/(array.analfabetas12_15[0]+array.analfabetas12_15[1]))*100)*-1),
                    female: Number((array.analfabetas12_15[1]/(array.analfabetas12_15[0]+array.analfabetas12_15[1]))*100)
                }
            ];
