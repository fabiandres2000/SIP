      ...
      <div class="kt-portlet__head">
        <div class="kt-portlet__head-label">
          <h3 class="kt-portlet__head-title">
            <span class="kt-widget20__number kt-font-danger">GESTIÓN DE BARRIOS</span>
          </h3>
        </div>
      </div>
              ...
              <div class="col-md-12">
                <div class="table-responsive">
                  <table class="table table-sm table-hover">
                    ...
                    <tbody>
                      <tr v-for="(item, index) in barrios" :key="index">
          ...
          <form>
            <div class="form-group row">
              ...
              <div class="col-lg-4">
                ...
                <b-form-select v-model="barriosData.muni" @change="cambio">
                  <option value selected>Seleccione</option>
                  <option
                    v-for="item in muni_options[barriosData.dpto]"
                    :value="item.value"
                    :key="item.value"
                  >{{item.texto}}</option>
                </b-form-select>
              ...
              <div class="col-lg-4" v-if="bandera">
                ...
                <b-form-select v-model="barriosData.corregimiento">
                  <option value="0" selected>Seleccione</option>
                  <option
                    v-for="item in corregi_options[barriosData.muni]"
                    :value="item.value"
                    :key="item.value"
                  >{{item.texto}}</option>
                </b-form-select>
            ...
            <div class="text-right">
              ...
              <button type="button" class="btn btn-success" @click="editarBarrio" v-else>
                <i class="fa fa-edit"></i> Guardar
              </button>
  ...
  export default {
    ...
    methods: {
      consultar: async function(pagina) {
        ...
        try {
          await barriosServicios.listarBarrios(parametros).then(respuesta => {
            ...
            // console.log(Object.keys(this.muni_options).length);
