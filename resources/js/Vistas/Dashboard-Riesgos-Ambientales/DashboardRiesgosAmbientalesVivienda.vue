<template lang="">
    <div>
                        ...
                        <div id="app" ref="document">
                            ...
                            <div ref="title" class="row" hidden>
                                <div class="col-sm-12 col-lg-12 text-left" style="padding: 1px 1px 1px 15px;">
                                    <h2>Riesgos Ambientales por Vivienda ({{ente}})</h2>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row" ref="tablaData">
                                ...
                                <div class="col-sm-12" style="padding-left: 20px; padding-top: 20px">
                                    <h2> Numero de viviendas por nivel de riesgo</h2>
                                </div>
                                    ...
                                    <table class="table_data" style="width: 100%">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>{{seriesRDerrumbe[0]}} - Viviendas</td>
                                                <td>{{seriesRDerrumbe[1]}} - Viviendas</td>
                                                <td>{{seriesRDerrumbe[2]}} - Viviendas</td>
                                            </tr>
                                            <tr>
                                                <td>Riesgos de Inundación </td>
                                                <td>{{seriesRInundacion[0]}} - Viviendas</td>
                                                <td>{{seriesRInundacion[1]}} - Viviendas</td>
                                                <td>{{seriesRInundacion[2]}} - Viviendas</td>
                                            </tr>
                                            <tr>
                                                <td>Riesgos de Insalubridad </td>
                                                <td>{{seriesRInsalubridad[0]}} - Viviendas</td>
                                                <td>{{seriesRInsalubridad[1]}} - Viviendas</td>
                                                <td>{{seriesRInsalubridad[2]}} - Viviendas</td>
                                            </tr>
                                            <tr>
                                                <td>Riesgo Atmosferico </td>
                                                <td>{{seriesRAtmosferico[0]}} - Viviendas</td>
                                                <td>{{seriesRAtmosferico[1]}} - Viviendas</td>
                                                <td>{{seriesRAtmosferico[2]}} - Viviendas</td>
                                            </tr>
                                            <tr>
                                                <td>Riesgo Recurso suelo </td>
                                                <td>{{seriesRRecursoSuelo[0]}} - Viviendas</td>
                                                <td>{{seriesRRecursoSuelo[1]}} - Viviendas</td>
                                                <td>{{seriesRRecursoSuelo[2]}} - Viviendas</td>
                                            </tr>
                                            <tr>
                                                <td>Riesgo por quemas o incendio</td>
                                                <td>{{seriesRQuemaIncendio[0]}} - Viviendas</td>
                                                <td>{{seriesRQuemaIncendio[1]}} - Viviendas</td>
                                                <td>{{seriesRQuemaIncendio[2]}} - Viviendas</td>
                                            </tr>
                                            <tr>
                                                <td>Riesgo Auditivo</td>
                                                <td>{{seriesRAuditivo[0]}} - Viviendas</td>
                                                <td>{{seriesRAuditivo[1]}} - Viviendas</td>
                                                <td>{{seriesRAuditivo[2]}} - Viviendas</td>
                                            </tr>
                                            <tr>
                                                <td>Riesgo Recurso Hidrico</td>
                                                <td>{{seriesRRecursoHidrico[0]}} - Viviendas</td>
                                                <td>{{seriesRRecursoHidrico[1]}} - Viviendas</td>
                                                <td>{{seriesRRecursoHidrico[2]}} - Viviendas</td>
                                            </tr>
                                            <tr>
                                                <td>Acceso a Agua Segura</td>
                                                <td>{{seriesRAccesoAgua[0]}} - Viviendas</td>
                                                <td>{{seriesRAccesoAgua[1]}} - Viviendas</td>
                                                <td>{{seriesRAccesoAgua[2]}} - Viviendas</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
          ...
          <div class="d-block">
            <form>
              ...
              <div class="form-group row">
                <div class="col-md-12">
                  <div class="table-responsive" style="height: 350px;">
                    <div class="container">
                        <h3 class="p-3 text-center">Detalle de las viviendas</h3>
              ...
              <div class="text-right">
                <button type="button" class="btn btn-warning" @click="mostrarModalMapa">
                  <i class="fa fa-map-marker" aria-hidden="true"></i> Geolocalizar
                </button>
        ...
        <b-modal
          ...
          :no-close-on-backdrop="true"
        >
          <div class="d-block" style="height: 700px">
            <form>
                 <div class="row">
                    <div class="col-sm-4 col-lg-4 text-left" style="padding: 20px;">
                ...
                <div class="form-group row">
                    <div class="col-md-12" v-if="points.length" ref="exportMapa">
                        <vue-google-heatmap
                            :points="points"
                            style="width: 100%;"
                            :height="500"
                    ...
                    <div style="height: 650px; width: 1285px; overflow: hidden" ref="exportarImagenMapa" hidden>
                        <vue-html2pdf
                            :show-layout="false"
                            :float-layout="true"
                            ...
                            ref="exportarImagenMapa2"
                        >
                            <section slot="pdf-content">
                                <div style="margin-top: 30px; margin-left: 30px">
                                    <h1>{{ente}}</h1>
                                    <h2>{{titulo2}}</h2>
                                    <h2>{{tituloModalMC}} - Nivel ({{tipoComboMC}})</h2>
                                    <br>
                                    <br>
                                    <br>
                                    <br>
                                    <br>
                                    <div style="height: 500px; width: 1274px; overflow: hidden">
                                        <img style="height: 600px; width: 1274px" :src="output"></img>
                                    </div>  
                                </div> 
                            </section>
                        </vue-html2pdf>
                    </div>
                    <div style="height: 450px;" class="col-md-12 text-center" v-if="visibleNodata">
                        <img style="width: 40%; height: 100%" src="https://i.pinimg.com/originals/49/e5/8d/49e58d5922019b8ec4642a2e2b9291c2.png" alt="cargando">
                    </div>
                    <div style="height: 450px; padding-top: 10%" class="col-md-12 text-center" v-if="loading">
                        <img  src="https://upload.wikimedia.org/wikipedia/commons/c/c7/Loading_2.gif?20170503175831" alt="cargando">
                    </div>
                </div>
                <div class="text-right">
                    <button type="button" class="btn btn-danger" @click="exportToPDFMapa">
                        <i class="fa fa-file"></i> Exportar PDF
                    </button>
                    <button type="button" class="btn btn-warning" @click="cerrarModalMapa">
                        <i class="fa fa-window-close"></i> Cerrar
                    </button>
                </div>
            </form>
...
export default {
    ...
    methods: {
        ...
        async filtrar(tipo) {
            ...
            await DashboardRiesgosAmbientalesService.listarEstadisticaPorVivienda(tipo, id)
            .then(respuesta => {
        ...
        async detalleControlAmbiental(idHogar) {
            ...
            this.$refs.modalDetAmbVIVI.show();
        },
        cerrarModalDetAmb(){
            this.$refs.modalDetAmbVIVI.hide();
        },
        async coordenadas() {
            let data = {
                _token: this.csrf
        ...
        async mostrarModalMapa(){
            this.tituloModalMC = "Mapa de calor - "+this.tituloModal;
            await this.filtrarDatosPorNivelRiesgo();
            this.$refs.modalMapaCalor.show();
        },
        cerrarModalMapa() {
            this.$refs.modalMapaCalor.hide();
        },
        async filtrarDatosPorNivelRiesgo() {
            this.points.splice(0);
            this.visibleNodata = false;
            this.loading = true;
            setTimeout(() => {
                if(this.tipoComboMC == "todos") {
                    ...
                    this.datosFiltrados.forEach(element => {
                        if(this.tipoComboMC == element.valoracionR){
                            this.points.push(
                                { lat: element.lat, lng: element.lng },
                            );
                        }
        ...
        async exportToPDFMapa(){
            this.$swal({
                title: 'Espere...',
                html: "<img src='https://upload.wikimedia.org/wikipedia/commons/c/c7/Loading_2.gif?20170503175831'>",
            ...
            setTimeout(() => {
                let data = Object.assign({}, this.$refs);
                data.exportarImagenMapa.removeAttribute("hidden");
                this.$refs.exportarImagenMapa2.generatePdf();
                data.exportarImagenMapa.setAttribute("hidden", "hidden");
            }, 1000)
        },
        hasDownloaded() {
            this.$swal().close();
        ...
        async buscarTitulo2(){
            if(this.tipoCombo == "todos"){
                this.titulo2 = "Todas las viviendas";
            }
