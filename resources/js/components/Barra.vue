        ...
        <div class="kt-header__topbar-item kt-header__topbar-item--user">
          <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
            <div class="kt-header__topbar-user">
              ...
              <span class="kt-header__topbar-username kt-hidden-mobile">{{nombreUsuario}}</span>
          ...
          >
            ...
            >
              ...
              <div class="kt-user-card__name">{{ nombreUsuario }}</div>
            </div>
            ...
            <div class="kt-notification">
              <a href="#" class="kt-notification__item">
                ...
                <div class="kt-notification__item-details">
                  ...
                  <div class="kt-notification__item-time">Configuar Cuenta</div>
                </div>
              </a>
              <a href="#" class="kt-notification__item">
                <div class="kt-notification__item-icon">
                ...
                <div class="kt-notification__item-details">
                  <div class="kt-notification__item-title kt-font-bold">Contraseña</div>
                  <div class="kt-notification__item-time">Cambiar Contraseñas</div>
                </div>
              </a>
      ...
      iniciar: async function() {
        ...
        try {
          await usuarioServicios
            .iniciar(parametros)
            .then(respuesta => {
              console.log(respuesta.data.OPC);
